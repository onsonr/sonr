...
// 	protoc        v3.17.3
// source: proto/core/protocols/discover.proto
...
func (VisibilityRequest_Visibility) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_core_protocols_discover_proto_enumTypes[0].Descriptor()
}

func (VisibilityRequest_Visibility) Type() protoreflect.EnumType {
	return &file_proto_core_protocols_discover_proto_enumTypes[0]
}
...
func (VisibilityRequest_Visibility) EnumDescriptor() ([]byte, []int) {
	return file_proto_core_protocols_discover_proto_rawDescGZIP(), []int{1, 0}
}
...
func (VisibilityResponse_Visibility) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_core_protocols_discover_proto_enumTypes[1].Descriptor()
}

func (VisibilityResponse_Visibility) Type() protoreflect.EnumType {
	return &file_proto_core_protocols_discover_proto_enumTypes[1]
}
...
func (VisibilityResponse_Visibility) EnumDescriptor() ([]byte, []int) {
	return file_proto_core_protocols_discover_proto_rawDescGZIP(), []int{2, 0}
}
...
func (x *LobbyMessage) Reset() {
	*x = LobbyMessage{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_core_protocols_discover_proto_msgTypes[0]
...
func (*LobbyMessage) Descriptor() ([]byte, []int) {
	return file_proto_core_protocols_discover_proto_rawDescGZIP(), []int{0}
}
...
func (x *VisibilityRequest) Reset() {
	*x = VisibilityRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_core_protocols_discover_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*VisibilityRequest) Descriptor() ([]byte, []int) {
	return file_proto_core_protocols_discover_proto_rawDescGZIP(), []int{1}
}
...
func (x *VisibilityResponse) Reset() {
	*x = VisibilityResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_core_protocols_discover_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*VisibilityResponse) Descriptor() ([]byte, []int) {
	return file_proto_core_protocols_discover_proto_rawDescGZIP(), []int{2}
}
...
var File_proto_core_protocols_discover_proto protoreflect.FileDescriptor

var file_proto_core_protocols_discover_proto_rawDesc = []byte{
	...
	0x44, 0x53, 0x10, 0x02, 0x42, 0x29, 0x5a, 0x27, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
	0x6f, 0x6d, 0x2f, 0x73, 0x6f, 0x6e, 0x72, 0x2d, 0x69, 0x6f, 0x2f, 0x63, 0x6f, 0x72, 0x65, 0x2f,
	0x78, 0x2f, 0x63, 0x6f, 0x72, 0x65, 0x2f, 0x64, 0x69, 0x73, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x62,
	0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_proto_core_protocols_discover_proto_rawDescOnce sync.Once
	file_proto_core_protocols_discover_proto_rawDescData = file_proto_core_protocols_discover_proto_rawDesc
)

func file_proto_core_protocols_discover_proto_rawDescGZIP() []byte {
	file_proto_core_protocols_discover_proto_rawDescOnce.Do(func() {
		file_proto_core_protocols_discover_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_core_protocols_discover_proto_rawDescData)
	})
	return file_proto_core_protocols_discover_proto_rawDescData
}

var file_proto_core_protocols_discover_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_proto_core_protocols_discover_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_proto_core_protocols_discover_proto_goTypes = []interface{}{
...
var file_proto_core_protocols_discover_proto_depIdxs = []int32{
...
func init() { file_proto_core_protocols_discover_proto_init() }
func file_proto_core_protocols_discover_proto_init() {
	if File_proto_core_protocols_discover_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_proto_core_protocols_discover_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_core_protocols_discover_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_core_protocols_discover_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	file_proto_core_protocols_discover_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_proto_core_protocols_discover_proto_rawDesc,
			NumEnums:      2,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_proto_core_protocols_discover_proto_goTypes,
		DependencyIndexes: file_proto_core_protocols_discover_proto_depIdxs,
		EnumInfos:         file_proto_core_protocols_discover_proto_enumTypes,
		MessageInfos:      file_proto_core_protocols_discover_proto_msgTypes,
	}.Build()
	File_proto_core_protocols_discover_proto = out.File
	file_proto_core_protocols_discover_proto_rawDesc = nil
	file_proto_core_protocols_discover_proto_goTypes = nil
	file_proto_core_protocols_discover_proto_depIdxs = nil
}
