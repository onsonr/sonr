...
func (IpnsEntry_ValidityType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_9d51d2bd3c178d08, []int{3, 0}
}
...
type IpnsEntry struct {
	...
	ValidityType IpnsEntry_ValidityType `protobuf:"varint,3,opt,name=validityType,proto3,enum=sonrio.sonr.bucket.IpnsEntry_ValidityType" json:"validityType,omitempty"`
	// optional
...
func (*IpnsEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_9d51d2bd3c178d08, []int{3}
}
...
func init() {
	...
	proto.RegisterEnum("sonrio.sonr.bucket.IpnsEntry_ValidityType", IpnsEntry_ValidityType_name, IpnsEntry_ValidityType_value)
	...
	proto.RegisterType((*IpnsEntry)(nil), "sonrio.sonr.bucket.IpnsEntry")
}
...
var fileDescriptor_9d51d2bd3c178d08 = []byte{
	...
	,
}
...
func (m *IpnsEntry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PubKey) > 0 {
		...
		i = encodeVarintWhereIs(dAtA, i, uint64(len(m.PubKey)))
		i--
		dAtA[i] = 0x3a
	}
	if m.Ttl != 0 {
		i = encodeVarintWhereIs(dAtA, i, uint64(m.Ttl))
		i--
		dAtA[i] = 0x30
	}
	if m.Sequence != 0 {
		i = encodeVarintWhereIs(dAtA, i, uint64(m.Sequence))
		i--
		dAtA[i] = 0x28
	}
	if len(m.Validity) > 0 {
		...
		i = encodeVarintWhereIs(dAtA, i, uint64(len(m.Validity)))
		i--
		dAtA[i] = 0x22
	}
	if m.ValidityType != 0 {
		i = encodeVarintWhereIs(dAtA, i, uint64(m.ValidityType))
		i--
		dAtA[i] = 0x18
	}
	if len(m.Signature) > 0 {
		...
		i = encodeVarintWhereIs(dAtA, i, uint64(len(m.Signature)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Value) > 0 {
		i -= len(m.Value)
		copy(dAtA[i:], m.Value)
		i = encodeVarintWhereIs(dAtA, i, uint64(len(m.Value)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *IpnsEntry) Size() (n int) {
	...
	if m.ValidityType != 0 {
		n += 1 + sovWhereIs(uint64(m.ValidityType))
	}
	l = len(m.Validity)
	if l > 0 {
		n += 1 + l + sovWhereIs(uint64(l))
	...
	if m.Sequence != 0 {
		n += 1 + sovWhereIs(uint64(m.Sequence))
	}
	if m.Ttl != 0 {
		n += 1 + sovWhereIs(uint64(m.Ttl))
	}
	l = len(m.PubKey)
	if l > 0 {
		n += 1 + l + sovWhereIs(uint64(l))
