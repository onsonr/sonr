...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_5256e3b680274a70, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_5256e3b680274a70, []int{1}
}
...
func (*QueryCredentialsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_5256e3b680274a70, []int{2}
}
...
func (*QueryCredentialsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_5256e3b680274a70, []int{3}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "sonrhq.sonr.service.v1.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "sonrhq.sonr.service.v1.QueryParamsResponse")
	proto.RegisterType((*QueryCredentialsRequest)(nil), "sonrhq.sonr.service.v1.QueryCredentialsRequest")
	proto.RegisterType((*QueryCredentialsResponse)(nil), "sonrhq.sonr.service.v1.QueryCredentialsResponse")
}

func init() {
	proto.RegisterFile("sonrhq/sonr/service/v1/query.proto", fileDescriptor_5256e3b680274a70)
}

var fileDescriptor_5256e3b680274a70 = []byte{
	// 471 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/sonrhq.sonr.service.v1.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Credentials(ctx context.Context, in *QueryCredentialsRequest, opts ...grpc.CallOption) (*QueryCredentialsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/sonrhq.sonr.service.v1.Query/Credentials", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sonrhq.sonr.service.v1.Query/Params",
	}
...
func _Query_Credentials_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sonrhq.sonr.service.v1.Query/Credentials",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (m *QueryCredentialsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.ParamsType != 0 {
		i = encodeVarintQuery(dAtA, i, uint64(m.ParamsType))
		i--
		dAtA[i] = 0x18
	}
...
func (m *QueryCredentialsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AttestationOptions) > 0 {
		...
		i = encodeVarintQuery(dAtA, i, uint64(len(m.AttestationOptions)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *QueryCredentialsRequest) Size() (n int) {
	...
	if m.ParamsType != 0 {
		n += 1 + sovQuery(uint64(m.ParamsType))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ParamsType |= ParamsType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
