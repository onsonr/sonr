...
func (KeyType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_14f033386008bc34, []int{0}
}
...
func (ProofType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_14f033386008bc34, []int{1}
}
...
type Proof struct {
	...
	Type ProofType `protobuf:"varint,1,opt,name=type,proto3,enum=sonrhq.core.service.ProofType" json:"type,omitempty"`
...
func (*VerifiableCredential) Descriptor() ([]byte, []int) {
	return fileDescriptor_14f033386008bc34, []int{2}
}
...
func init() {
	proto.RegisterEnum("sonrhq.core.service.KeyType", KeyType_name, KeyType_value)
	proto.RegisterEnum("sonrhq.core.service.ProofType", ProofType_name, ProofType_value)
	proto.RegisterType((*Proof)(nil), "sonrhq.core.service.Proof")
	proto.RegisterType((*JSONWebSignature2020Proof)(nil), "sonrhq.core.service.JSONWebSignature2020Proof")
	proto.RegisterType((*VerifiableCredential)(nil), "sonrhq.core.service.VerifiableCredential")
	proto.RegisterMapType((map[string]string)(nil), "sonrhq.core.service.VerifiableCredential.CredentialSubjectEntry")
	proto.RegisterMapType((map[string]string)(nil), "sonrhq.core.service.VerifiableCredential.ProofEntry")
}

func init() { proto.RegisterFile("core/service/ssi.proto", fileDescriptor_14f033386008bc34) }

var fileDescriptor_14f033386008bc34 = []byte{
	// 692 bytes of a gzipped FileDescriptorProto
	,
}
