...
func (x *fastReflection_Capability) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "dwn.v1.Capability.command":
		return x.Command != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_Capability) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "dwn.v1.Capability.command":
		panic(fmt.Errorf("field command of message dwn.v1.Capability is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: dwn.v1.Capability"))
		}
...
var file_dwn_v1_genesis_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x42, 0x7d, 0x0a, 0x0a, 0x63, 0x6f, 0x6d, 0x2e,
	0x64, 0x77, 0x6e, 0x2e, 0x76, 0x31, 0x42, 0x0c, 0x47, 0x65, 0x6e, 0x65, 0x73, 0x69, 0x73, 0x50,
