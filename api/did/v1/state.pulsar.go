...
var file_did_v1_state_proto_rawDesc = []byte{
	...
	0x18, 0x03, 0x22, 0x84, 0x04, 0x0a, 0x0c, 0x56, 0x65, 0x72, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74,
...
var file_did_v1_state_proto_goTypes = []interface{}{
	...
	(*Verification)(nil),   // 3: did.v1.Verification
	nil,                    // 4: did.v1.Assertion.AccumulatorEntry
	nil,                    // 5: did.v1.Authentication.MetadataEntry
	nil,                    // 6: did.v1.Verification.MetadataEntry
...
var file_did_v1_state_proto_depIdxs = []int32{
	...
	4, // 1: did.v1.Assertion.accumulator:type_name -> did.v1.Assertion.AccumulatorEntry
	7, // 2: did.v1.Authentication.public_key:type_name -> did.v1.PubKey
	5, // 3: did.v1.Authentication.metadata:type_name -> did.v1.Authentication.MetadataEntry
	7, // 4: did.v1.Controller.public_key:type_name -> did.v1.PubKey
	7, // 5: did.v1.Verification.public_key:type_name -> did.v1.PubKey
	6, // 6: did.v1.Verification.metadata:type_name -> did.v1.Verification.MetadataEntry
