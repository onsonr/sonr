...
var _ protoreflect.List = (*_Controller_7_list)(nil)

type _Controller_7_list struct {
	list *[]*Property
}

func (x *_Controller_7_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_Controller_7_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_Controller_7_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*Property)
	(*x.list)[i] = concreteValue
}

func (x *_Controller_7_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*Property)
	*x.list = append(*x.list, concreteValue)
}

func (x *_Controller_7_list) AppendMutable() protoreflect.Value {
	v := new(Property)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_Controller_7_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_Controller_7_list) NewElement() protoreflect.Value {
	v := new(Property)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_Controller_7_list) IsValid() bool {
	return x.list != nil
}
...
func (x *fastReflection_Controller) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.Properties) != 0 {
		value := protoreflect.ValueOfList(&_Controller_7_list{list: &x.Properties})
...
func (x *fastReflection_Controller) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "did.v1.Controller.properties":
		if len(x.Properties) == 0 {
			return protoreflect.ValueOfList(&_Controller_7_list{})
		}
		listValue := &_Controller_7_list{list: &x.Properties}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: did.v1.Controller"))
...
func (x *fastReflection_Controller) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "did.v1.Controller.properties":
		...
		value := &_Controller_7_list{list: &x.Properties}
		return protoreflect.ValueOfList(value)
	case "did.v1.Controller.address":
...
func (x *fastReflection_Controller) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "did.v1.Controller.properties":
		list := []*Property{}
		return protoreflect.ValueOfList(&_Controller_7_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: did.v1.Controller"))
		}
...
func init() {
	file_did_v1_genesis_proto_init()
	md_Property = File_did_v1_genesis_proto.Messages().ByName("Property")
...
func (x *Controller) GetProperties() []*Property {
	if x != nil {
		return x.Properties
	}
	return nil
...
var file_did_v1_genesis_proto_rawDesc = []byte{
	...
	0x73, 0x22, 0x86, 0x02, 0x0a, 0x0a, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x65, 0x72,
	...
	,
	...
	0x07, 0x6b, 0x65, 0x79, 0x54, 0x79, 0x70, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x64, 0x69, 0x64, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x64, 0x69, 0x64, 0x3a, 0x24, 0x98, 0xa0, 0x1f, 0x00,
	0x8a, 0xe7, 0xb0, 0x2a, 0x0d, 0x64, 0x69, 0x64, 0x2f, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x6b,
	0x65, 0x79, 0x92, 0xe7, 0xb0, 0x2a, 0x09, 0x6b, 0x65, 0x79, 0x5f, 0x66, 0x69, 0x65, 0x6c, 0x64,
	...
	0x6f, 0x2f, 0x63, 0x6f, 0x72, 0x65, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x64, 0x69, 0x64, 0x2f, 0x76,
...
var file_did_v1_genesis_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_did_v1_genesis_proto_goTypes = []interface{}{
	...
	(*Property)(nil),     // 3: did.v1.Property
...
var file_did_v1_genesis_proto_depIdxs = []int32{
	...
	3, // 3: did.v1.Controller.properties:type_name -> did.v1.Property
