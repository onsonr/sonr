...
func (x *fastReflection_Capability) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "did.v1.Capability.command":
		return x.Command != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_Capability) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "did.v1.Capability.command":
		panic(fmt.Errorf("field command of message did.v1.Capability is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: did.v1.Capability"))
		}
...
var file_did_v1_genesis_proto_rawDesc = []byte{
	...
	0x6c, 0x69, 0x74, 0x69, 0x65, 0x73, 0x22, 0x74, 0x0a, 0x0a, 0x43, 0x61, 0x70, 0x61, 0x62, 0x69,
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x22, 0x3a, 0x0a, 0x08,
	...
	0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x22, 0x91, 0x02, 0x0a, 0x08, 0x44, 0x6f, 0x63,
	...
	0x03, 0x28, 0x09, 0x52, 0x07, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x42, 0x7d, 0x0a, 0x0a,
