...
var (
	...
	fd_Capability_command     protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_Capability_command = md_Capability.Fields().ByName("command")
}
...
func (x *fastReflection_Capability) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.Command != "" {
		value := protoreflect.ValueOfString(x.Command)
		if !f(fd_Capability_command, value) {
			return
		}
	}
}
...
func (x *fastReflection_Capability) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "svc.v1.Capability.command":
		return x.Command != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_Capability) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "svc.v1.Capability.command":
		x.Command = value.Interface().(string)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: svc.v1.Capability"))
		}
...
func (x *fastReflection_Capability) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "svc.v1.Capability.command":
		panic(fmt.Errorf("field command of message svc.v1.Capability is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: svc.v1.Capability"))
		}
...
func (x *fastReflection_Capability) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.Command) > 0 {
			i -= len(x.Command)
			copy(dAtA[i:], x.Command)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.Command)))
			i--
			dAtA[i] = 0x22
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 4:
				...
				x.Command = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			default:
				iNdEx = preIndex
				skippy, err := runtime.Skip(dAtA[iNdEx:])
...
var file_svc_v1_genesis_proto_rawDesc = []byte{
	...
	0x70, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x69, 0x65, 0x73, 0x22, 0x74, 0x0a, 0x0a, 0x43, 0x61,
	...
	0x28, 0x09, 0x52, 0x08, 0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x22, 0xf9, 0x01, 0x0a,
	...
	0x68, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x12, 0x18, 0x0a, 0x07, 0x6f, 0x72, 0x69, 0x67, 0x69, 0x6e,
	...
	,
	...
	0x61, 0x70, 0x69, 0x2f, 0x73, 0x76, 0x63, 0x2f, 0x76, 0x31, 0x3b, 0x73, 0x76, 0x63, 0x76, 0x31,
	0xa2, 0x02, 0x03, 0x53, 0x58, 0x58, 0xaa, 0x02, 0x06, 0x53, 0x76, 0x63, 0x2e, 0x56, 0x31, 0xca,
	0x02, 0x06, 0x53, 0x76, 0x63, 0x5c, 0x56, 0x31, 0xe2, 0x02, 0x12, 0x53, 0x76, 0x63, 0x5c, 0x56,
