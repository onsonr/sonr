...
const (
	Msg_IncrementCounter_FullMethodName = "/sonrhq.sonr.identity.v1.Msg/IncrementCounter"
	Msg_UpdateParams_FullMethodName     = "/sonrhq.sonr.identity.v1.Msg/UpdateParams"
)
