...
func NewEmailAuthData(email string, key didcommon.SecretKey) (*AuthData, error) {
...
func NewCredentialAuthData(cred *didcommon.Credential, origin string, key didcommon.SecretKey) (*AuthData, error) {
...
func (a *AuthData) GetSecretKeyFromEmail(email string) (didcommon.SecretKey, error) {
	hash := blake3.Sum256([]byte(email))
