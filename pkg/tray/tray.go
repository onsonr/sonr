...
func Start(box packr.Box) InterfaceTray {
	// Check Platform
...
func (ai *InterfaceTray) Initialize(n *sonr.Node) {
	// Set Node
	ai.node = n
...
func (ai *InterfaceTray) HandleMenuInput() {
	for {
		select {
		// @ File Item Clicked
...
func (ai *InterfaceTray) HandlePeerInput(fileItem *systray.MenuItem, linkItem *systray.MenuItem, peer *md.Peer) {
	for {
		select {
		// @ File Item Clicked
...
func (ai *InterfaceTray) RefreshPeers(newLob *md.Lobby, node *sonr.Node) {
	// Set Node
	ai.node = node
...
func (ai *InterfaceTray) SetPeerItem(p *md.Peer) {
	// Add Peer to Menu
