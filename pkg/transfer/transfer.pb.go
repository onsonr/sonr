...
type InviteRequest struct {
	...
	Uuid     string           `protobuf:"bytes,2,opt,name=uuid,proto3" json:"uuid,omitempty"`         // Invitation ID (UUID) signed by the sender
...
func (x *InviteRequest) GetUuid() string {
	if x != nil {
		return x.Uuid
	}
	return ""
...
func (x *InviteResponse) GetUuid() string {
	if x != nil {
		return x.Uuid
	}
	return ""
...
var file_proto_protocols_transfer_proto_rawDesc = []byte{
	...
	0x2f, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc8, 0x01, 0x0a, 0x0d,
	...
	0x61, 0x64, 0x52, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x75,
	...
	0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0xb7, 0x01, 0x0a, 0x0e, 0x49, 0x6e, 0x76, 0x69, 0x74,
	...
	0x69, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x12, 0x0a, 0x04, 0x75, 0x75, 0x69, 0x64, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x04, 0x75, 0x75, 0x69, 0x64, 0x12, 0x23, 0x0a, 0x04, 0x66, 0x72, 0x6f,
...
var file_proto_protocols_transfer_proto_depIdxs = []int32{
	...
	3, // 1: sonr.protocols.transfer.InviteRequest.from:type_name -> sonr.core.Peer
	3, // 2: sonr.protocols.transfer.InviteRequest.to:type_name -> sonr.core.Peer
	4, // 3: sonr.protocols.transfer.InviteRequest.metadata:type_name -> sonr.core.Metadata
	3, // 4: sonr.protocols.transfer.InviteResponse.from:type_name -> sonr.core.Peer
	3, // 5: sonr.protocols.transfer.InviteResponse.to:type_name -> sonr.core.Peer
	4, // 6: sonr.protocols.transfer.InviteResponse.metadata:type_name -> sonr.core.Metadata
