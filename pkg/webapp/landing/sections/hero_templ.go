...
import (
	"fmt"
	"github.com/onsonr/sonr/pkg/design/ui"
	models "github.com/onsonr/sonr/pkg/webapp/landing/models"
)
...
func Hero() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/webapp/landing/sections/hero.templ`, Line: 49, Col: 22}
		}
...
func heroTitle(first string, emphasis string, second string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/webapp/landing/sections/hero.templ`, Line: 66, Col: 9}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/webapp/landing/sections/hero.templ`, Line: 68, Col: 13}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/webapp/landing/sections/hero.templ`, Line: 73, Col: 10}
		}
...
func heroImage(hero *models.Hero) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/webapp/landing/sections/hero.templ`, Line: 82, Col: 23}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/webapp/landing/sections/hero.templ`, Line: 83, Col: 27}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/webapp/landing/sections/hero.templ`, Line: 84, Col: 29}
		}
...
func stats(stats []*models.Stat) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, item := range stats {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/webapp/landing/sections/hero.templ`, Line: 96, Col: 122}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/webapp/landing/sections/hero.templ`, Line: 96, Col: 159}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/webapp/landing/sections/hero.templ`, Line: 96, Col: 180}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/webapp/landing/sections/hero.templ`, Line: 97, Col: 50}
			}
