...
func (rm *accountLinker) initSync() *md.SonrError {
...
func (rm *accountLinker) handleSyncEvents(ctx context.Context) {
	// Loop Events
	for {
		// Get next event
...
func (rm *accountLinker) handleSyncMessages(ctx context.Context) {
	for {
