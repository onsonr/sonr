...
func SignCosmosTx(anySigner didcommon.AnySignerEntity, msgs ...sdk.Msg) ([]byte, error) {
	// Build TxBody
...
func GetAuthInfo(anySigner didcommon.AnySignerEntity, gas sdk.Coins) (*txtypes.AuthInfo, error) {
...
func SignDocWithKSS(anySigner didcommon.AnySignerEntity, signDoc *txtypes.SignDoc) ([]byte, error) {
