...
func (ks *keyshares) Usr() UserI {
	return ks.usr
}

// Val returns the validator keyshare
func (ks *keyshares) Val() ValI {
	return ks.val
}
...
func NewKeyshareSet(aliceResult *protocol.Message, bobResult *protocol.Message) SetI {
	return &keyshares{
...
func createUserKeyshare(usrKSS *protocol.Message) UserI {
	return &userKeyshare{
		usrKSS: usrKSS,
	}
}
...
func createValidatorKeyshare(valKSS *protocol.Message) ValI {
