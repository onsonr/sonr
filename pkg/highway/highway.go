...
func Start(opts ...HighwayOption) {
	...
	handlers.BankAPI.RegisterRoutes(e)
	handlers.GovAPI.RegisterRoutes(e)
	handlers.StakingAPI.RegisterRoutes(e)
	handlers.CometAPI.RegisterRoutes(e)
	handlers.ServiceAPI.RegisterRoutes(e)
	handlers.MountHTMX(e)
