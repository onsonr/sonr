...
func RegisterSonrAPI(e *echo.Echo) {
	...
	e.GET("/service/:origin/email/:email/confirm", api.ServiceAPI.VerifyEmail)
	e.POST("/service/:origin/email/:email/verify", api.ServiceAPI.SendVerificationEmail)
