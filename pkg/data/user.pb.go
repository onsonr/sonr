...
var file_user_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6c, 0x65, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74, 0x22, 0x85, 0x03, 0x0a, 0x06, 0x44,
...
var file_user_proto_goTypes = []interface{}{
	...
	(*Device)(nil),                 // 7: data.Device
	(*FileSystem)(nil),             // 8: data.FileSystem
	(*KeyChain)(nil),               // 9: data.KeyChain
	(*KeyPair)(nil),                // 10: data.KeyPair
	(*User)(nil),                   // 11: data.User
	...
	(Platform)(0),                  // 15: data.Platform
	(*Location)(nil),               // 16: data.Location
	(*Peer)(nil),                   // 17: data.Peer
	(*Contact)(nil),                // 18: data.Contact
	(*Member)(nil),                 // 19: data.Member
}
var file_user_proto_depIdxs = []int32{
	8,  // 0: data.Device.fileSystem:type_name -> data.FileSystem
	15, // 1: data.Device.platform:type_name -> data.Platform
	9,  // 2: data.Device.keyChain:type_name -> data.KeyChain
	2,  // 3: data.Device.status:type_name -> data.Status
	16, // 4: data.Device.location:type_name -> data.Location
	17, // 5: data.Device.peer:type_name -> data.Peer
	18, // 6: data.Device.contact:type_name -> data.Contact
	12, // 7: data.FileSystem.downloads:type_name -> data.FileSystem.Directory
	12, // 8: data.FileSystem.support:type_name -> data.FileSystem.Directory
	12, // 9: data.FileSystem.temporary:type_name -> data.FileSystem.Directory
	12, // 10: data.FileSystem.private:type_name -> data.FileSystem.Directory
	10, // 11: data.KeyChain.account:type_name -> data.KeyPair
	10, // 12: data.KeyChain.device:type_name -> data.KeyPair
	10, // 13: data.KeyChain.group:type_name -> data.KeyPair
	14, // 14: data.KeyChain.deviceLinkPubKey:type_name -> data.KeyPair.Public
	13, // 15: data.KeyPair.private:type_name -> data.KeyPair.Private
	14, // 16: data.KeyPair.public:type_name -> data.KeyPair.Public
	0,  // 17: data.KeyPair.signature:type_name -> data.Signature
	4,  // 18: data.KeyPair.type:type_name -> data.KeyPair.Type
	5,  // 19: data.User.state:type_name -> data.User.State
	6,  // 20: data.User.apiKeys:type_name -> data.APIKeys
	9,  // 21: data.User.keyChain:type_name -> data.KeyChain
	18, // 22: data.User.contact:type_name -> data.Contact
	19, // 23: data.User.member:type_name -> data.Member
	7,  // 24: data.User.primary:type_name -> data.Device
	7,  // 25: data.User.current:type_name -> data.Device
	7,  // 26: data.User.devices:type_name -> data.Device
	3,  // 27: data.FileSystem.Directory.type:type_name -> data.FileSystem.Directory.Type
