...
var file_user_proto_rawDesc = []byte{
	...
	0x08, 0x12, 0x0a, 0x0a, 0x06, 0x4c, 0x49, 0x4e, 0x4b, 0x45, 0x52, 0x10, 0x09, 0x42, 0x07, 0x5a,
	0x05, 0x2f, 0x64, 0x61, 0x74, 0x61, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_user_proto_goTypes = []interface{}{
	...
	(*FileSystem_Directory)(nil),   // 12: data.FileSystem.Directory
	(*KeyPair_Private)(nil),        // 13: data.KeyPair.Private
	(*KeyPair_Public)(nil),         // 14: data.KeyPair.Public
	(*Contact)(nil),                // 15: data.Contact
	(*Member)(nil),                 // 16: data.Member
	(Platform)(0),                  // 17: data.Platform
	(*Location)(nil),               // 18: data.Location
	(*Peer)(nil),                   // 19: data.Peer
}
var file_user_proto_depIdxs = []int32{
	3,  // 0: data.Account.state:type_name -> data.Account.State
	6,  // 1: data.Account.apiKeys:type_name -> data.APIKeys
	10, // 2: data.Account.keyChain:type_name -> data.KeyChain
	15, // 3: data.Account.contact:type_name -> data.Contact
	16, // 4: data.Account.member:type_name -> data.Member
	8,  // 5: data.Account.primary:type_name -> data.Device
	8,  // 6: data.Account.current:type_name -> data.Device
	8,  // 7: data.Account.devices:type_name -> data.Device
	9,  // 8: data.Device.fileSystem:type_name -> data.FileSystem
	17, // 9: data.Device.platform:type_name -> data.Platform
	10, // 10: data.Device.keyChain:type_name -> data.KeyChain
	2,  // 11: data.Device.status:type_name -> data.Status
	18, // 12: data.Device.location:type_name -> data.Location
	19, // 13: data.Device.peer:type_name -> data.Peer
	15, // 14: data.Device.contact:type_name -> data.Contact
	12, // 15: data.FileSystem.downloads:type_name -> data.FileSystem.Directory
	12, // 16: data.FileSystem.support:type_name -> data.FileSystem.Directory
	12, // 17: data.FileSystem.temporary:type_name -> data.FileSystem.Directory
	12, // 18: data.FileSystem.private:type_name -> data.FileSystem.Directory
	11, // 19: data.KeyChain.account:type_name -> data.KeyPair
	11, // 20: data.KeyChain.device:type_name -> data.KeyPair
	11, // 21: data.KeyChain.group:type_name -> data.KeyPair
	14, // 22: data.KeyChain.deviceLinkPubKey:type_name -> data.KeyPair.Public
	13, // 23: data.KeyPair.private:type_name -> data.KeyPair.Private
	14, // 24: data.KeyPair.public:type_name -> data.KeyPair.Public
	0,  // 25: data.KeyPair.signature:type_name -> data.Signature
	5,  // 26: data.KeyPair.type:type_name -> data.KeyPair.Type
	4,  // 27: data.FileSystem.Directory.type:type_name -> data.FileSystem.Directory.Type
