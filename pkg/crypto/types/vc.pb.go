...
func (*JSONWebSignature2020Proof) Descriptor() ([]byte, []int) {
	return fileDescriptor_64c0ba2ef76e413c, []int{1}
}
...
func (*VerifiableCredential) Descriptor() ([]byte, []int) {
	return fileDescriptor_64c0ba2ef76e413c, []int{2}
}
...
func init() {
	proto.RegisterType((*Proof)(nil), "sonrhq.common.crypto.Proof")
	proto.RegisterType((*JSONWebSignature2020Proof)(nil), "sonrhq.common.crypto.JSONWebSignature2020Proof")
	proto.RegisterType((*VerifiableCredential)(nil), "sonrhq.common.crypto.VerifiableCredential")
	proto.RegisterMapType((map[string]string)(nil), "sonrhq.common.crypto.VerifiableCredential.CredentialSubjectEntry")
	proto.RegisterMapType((map[string]string)(nil), "sonrhq.common.crypto.VerifiableCredential.ProofEntry")
}
...
var fileDescriptor_64c0ba2ef76e413c = []byte{
	...
	,
}
