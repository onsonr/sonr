...
var file_proto_protocols_transmit_proto_rawDesc = []byte{
	...
	0x2f, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd3, 0x01, 0x0a, 0x07,
	...
	0x2f, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x6d, 0x69, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_proto_protocols_transmit_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_proto_protocols_transmit_proto_goTypes = []interface{}{
	(*Session)(nil),        // 0: sonr.protocols.transmit.Session
	(common.Direction)(0),  // 1: sonr.core.Direction
...
var file_proto_protocols_transmit_proto_depIdxs = []int32{
	1, // 0: sonr.protocols.transmit.Session.direction:type_name -> sonr.core.Direction
	2, // 1: sonr.protocols.transmit.Session.from:type_name -> sonr.core.Peer
	2, // 2: sonr.protocols.transmit.Session.to:type_name -> sonr.core.Peer
	3, // 3: sonr.protocols.transmit.Session.payload:type_name -> sonr.core.Payload
