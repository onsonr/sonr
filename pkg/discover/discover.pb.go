...
func (VisibilityRequest_Visibility) EnumDescriptor() ([]byte, []int) {
	return file_proto_protocols_discover_proto_rawDescGZIP(), []int{4, 0}
}
...
func (VisibilityResponse_Visibility) EnumDescriptor() ([]byte, []int) {
	return file_proto_protocols_discover_proto_rawDescGZIP(), []int{5, 0}
}
...
func (x *LookupResponse) Reset() {
	*x = LookupResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_protocols_discover_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*LookupResponse) Descriptor() ([]byte, []int) {
	return file_proto_protocols_discover_proto_rawDescGZIP(), []int{3}
}
...
func (x *VisibilityRequest) Reset() {
	*x = VisibilityRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_protocols_discover_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*VisibilityRequest) Descriptor() ([]byte, []int) {
	return file_proto_protocols_discover_proto_rawDescGZIP(), []int{4}
}
...
func (x *VisibilityResponse) Reset() {
	*x = VisibilityResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_protocols_discover_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*VisibilityResponse) Descriptor() ([]byte, []int) {
	return file_proto_protocols_discover_proto_rawDescGZIP(), []int{5}
}
...
func (x *LobbyMessage) Reset() {
	*x = LobbyMessage{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_protocols_discover_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*LobbyMessage) Descriptor() ([]byte, []int) {
	return file_proto_protocols_discover_proto_rawDescGZIP(), []int{6}
}
...
var file_proto_protocols_discover_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x76, 0x65, 0x72, 0x2e, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x7a, 0x65, 0x52,
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x73, 0x2e, 0x64, 0x69, 0x73, 0x63, 0x6f, 0x76,
	0x65, 0x72, 0x2e, 0x56, 0x69, 0x73, 0x69, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x52, 0x65, 0x71,
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x73, 0x2e, 0x64, 0x69, 0x73, 0x63, 0x6f,
	0x76, 0x65, 0x72, 0x2e, 0x56, 0x69, 0x73, 0x69, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x52, 0x65,
	...
	0x67, 0x2f, 0x64, 0x69, 0x73, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_proto_protocols_discover_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_proto_protocols_discover_proto_goTypes = []interface{}{
	...
	(*AuthorizeRequest)(nil),           // 2: sonr.protocols.discover.AuthorizeRequest
	(*AuthorizeResponse)(nil),          // 3: sonr.protocols.discover.AuthorizeResponse
	(*LookupRequest)(nil),              // 4: sonr.protocols.discover.LookupRequest
	(*LookupResponse)(nil),             // 5: sonr.protocols.discover.LookupResponse
	(*VisibilityRequest)(nil),          // 6: sonr.protocols.discover.VisibilityRequest
	(*VisibilityResponse)(nil),         // 7: sonr.protocols.discover.VisibilityResponse
	(*LobbyMessage)(nil),               // 8: sonr.protocols.discover.LobbyMessage
	nil,                                // 9: sonr.protocols.discover.AuthorizeResponse.RecordsEntry
...
var file_proto_protocols_discover_proto_depIdxs = []int32{
	9,  // 0: sonr.protocols.discover.AuthorizeResponse.records:type_name -> sonr.protocols.discover.AuthorizeResponse.RecordsEntry
	0,  // 1: sonr.protocols.discover.VisibilityRequest.visibility:type_name -> sonr.protocols.discover.VisibilityRequest.Visibility
	1,  // 2: sonr.protocols.discover.VisibilityResponse.visibility:type_name -> sonr.protocols.discover.VisibilityResponse.Visibility
	10, // 3: sonr.protocols.discover.LobbyMessage.peer:type_name -> sonr.core.Peer
	11, // 4: sonr.protocols.discover.LobbyMessage.metadata:type_name -> sonr.core.Metadata
...
func file_proto_protocols_discover_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_protocols_discover_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_protocols_discover_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_protocols_discover_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_protocols_discover_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
	...
	file_proto_protocols_discover_proto_msgTypes[6].OneofWrappers = []interface{}{}
	type x struct{}
