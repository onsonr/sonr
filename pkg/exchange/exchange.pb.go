...
func (VisibilityRequest_Visibility) EnumDescriptor() ([]byte, []int) {
	return file_proto_protocols_exchange_proto_rawDescGZIP(), []int{2, 0}
}
...
var file_proto_protocols_exchange_proto_goTypes = []interface{}{
	...
	(*VisibilityRequest)(nil),          // 4: sonr.protocols.exchange.VisibilityRequest
	(*VisibilityResponse)(nil),         // 5: sonr.protocols.exchange.VisibilityResponse
}
