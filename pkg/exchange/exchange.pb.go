...
// UpdateEvent is message for Exchange Protocol
...
func (x *UpdateEvent) GetOlc() string {
	if x != nil {
		return x.Olc
	}
	return ""
...
func (x *UpdateEvent) GetPeer() *common.Peer {
	if x != nil {
		return x.Peer
	}
	return nil
...
var file_proto_protocols_exchange_proto_rawDesc = []byte{
	...
	0x72, 0x22, 0x44, 0x0a, 0x0b, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x45, 0x76, 0x65, 0x6e, 0x74,
	0x12, 0x10, 0x0a, 0x03, 0x6f, 0x6c, 0x63, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6f,
	0x6c, 0x63, 0x12, 0x23, 0x0a, 0x04, 0x70, 0x65, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x0f, 0x2e, 0x73, 0x6f, 0x6e, 0x72, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x50, 0x65, 0x65,
	0x72, 0x52, 0x04, 0x70, 0x65, 0x65, 0x72, 0x42, 0x26, 0x5a, 0x24, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_proto_protocols_exchange_proto_goTypes = []interface{}{
	...
	(*UpdateEvent)(nil),          // 2: sonr.protocols.exchange.UpdateEvent
...
var file_proto_protocols_exchange_proto_depIdxs = []int32{
	...
	3, // 2: sonr.protocols.exchange.UpdateEvent.peer:type_name -> sonr.core.Peer
