...
var file_proto_protocols_exchange_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proto_protocols_exchange_proto_goTypes = []interface{}{
	...
	(*common.Peer)(nil),          // 2: sonr.core.Peer
}
var file_proto_protocols_exchange_proto_depIdxs = []int32{
	2, // 0: sonr.protocols.exchange.JoinExchangeRequest.peer:type_name -> sonr.core.Peer
	2, // 1: sonr.protocols.exchange.JoinExchangeResponse.peer:type_name -> sonr.core.Peer
