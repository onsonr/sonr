...
var file_peer_proto_goTypes = []interface{}{
	...
	(*Lobby_LocalInfo)(nil),        // 12: Lobby.LocalInfo
...
var file_peer_proto_depIdxs = []int32{
	...
	12, // 3: Lobby.info:type_name -> Lobby.LocalInfo
	8,  // 4: LocalEvent.from:type_name -> Peer
	3,  // 5: LocalEvent.subject:type_name -> LocalEvent.Subject
	13, // 6: Peer.id:type_name -> Peer.ID
	1,  // 7: Peer.platform:type_name -> Platform
	9,  // 8: Peer.position:type_name -> Position
	10, // 9: Peer.profile:type_name -> Profile
	14, // 10: Peer.properties:type_name -> Peer.Properties
	16, // 11: Position.facing:type_name -> Position.Compass
	16, // 12: Position.heading:type_name -> Position.Compass
	4,  // 13: Position.proximity:type_name -> Position.Proximity
	15, // 14: Position.accelerometer:type_name -> Position.Accelerometer
	17, // 15: Position.orientation:type_name -> Position.Orientation
