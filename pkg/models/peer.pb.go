...
type Peer_ID struct {
	...
	PublicKey string `protobuf:"bytes,5,opt,name=publicKey,proto3" json:"publicKey,omitempty"` // Public Key of Peer
	PushToken string `protobuf:"bytes,6,opt,name=pushToken,proto3" json:"pushToken,omitempty"` // Push Notification token
}
...
var file_peer_proto_rawDesc = []byte{
	...
	0x74, 0x75, 0x73, 0x12, 0x09, 0x0a, 0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x10, 0x00, 0x12, 0x07,
	0x0a, 0x03, 0x46, 0x65, 0x77, 0x10, 0x01, 0x12, 0x08, 0x0a, 0x04, 0x4d, 0x61, 0x6e, 0x79, 0x10,
	...
	0x22, 0xfc, 0x03, 0x0a, 0x04, 0x50, 0x65, 0x65, 0x72, 0x12, 0x14, 0x0a, 0x05, 0x73, 0x4e, 0x61,
	...
	,
...
var file_peer_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
...
var file_peer_proto_goTypes = []interface{}{
	...
	(Position_Proximity)(0),        // 3: models.Position.Proximity
	(Topic_Type)(0),                // 4: models.Topic.Type
	(*Lobby)(nil),                  // 5: models.Lobby
	(*Location)(nil),               // 6: models.Location
	(*Peer)(nil),                   // 7: models.Peer
	(*Position)(nil),               // 8: models.Position
	(*Profile)(nil),                // 9: models.Profile
	(*Topic)(nil),                  // 10: models.Topic
	nil,                            // 11: models.Lobby.PeersEntry
	(*Location_Placemark)(nil),     // 12: models.Location.Placemark
	(*Peer_ID)(nil),                // 13: models.Peer.ID
	(*Peer_Properties)(nil),        // 14: models.Peer.Properties
	(*Position_Accelerometer)(nil), // 15: models.Position.Accelerometer
	(*Position_Compass)(nil),       // 16: models.Position.Compass
	(*Position_Orientation)(nil),   // 17: models.Position.Orientation
}
var file_peer_proto_depIdxs = []int32{
	10, // 0: models.Lobby.topic:type_name -> models.Topic
	11, // 1: models.Lobby.peers:type_name -> models.Lobby.PeersEntry
	2,  // 2: models.Lobby.status:type_name -> models.Lobby.Status
	12, // 3: models.Location.placemark:type_name -> models.Location.Placemark
	13, // 4: models.Peer.id:type_name -> models.Peer.ID
	1,  // 5: models.Peer.platform:type_name -> models.Platform
	8,  // 6: models.Peer.position:type_name -> models.Position
	9,  // 7: models.Peer.profile:type_name -> models.Profile
	14, // 8: models.Peer.properties:type_name -> models.Peer.Properties
	16, // 9: models.Position.facing:type_name -> models.Position.Compass
	16, // 10: models.Position.heading:type_name -> models.Position.Compass
	3,  // 11: models.Position.proximity:type_name -> models.Position.Proximity
	15, // 12: models.Position.accelerometer:type_name -> models.Position.Accelerometer
	17, // 13: models.Position.orientation:type_name -> models.Position.Orientation
	1,  // 14: models.Profile.platform:type_name -> models.Platform
	4,  // 15: models.Topic.type:type_name -> models.Topic.Type
	7,  // 16: models.Lobby.PeersEntry.value:type_name -> models.Peer
	0,  // 17: models.Position.Compass.cardinal:type_name -> models.Cardinal
	0,  // 18: models.Position.Compass.antiCardinal:type_name -> models.Cardinal
