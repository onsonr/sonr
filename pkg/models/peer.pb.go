...
var file_peer_proto_rawDesc = []byte{
	...
	0x62, 0x54, 0x68, 0x6f, 0x72, 0x6f, 0x75, 0x67, 0x68, 0x66, 0x61, 0x72, 0x65, 0x22, 0x88, 0x05,
	...
	0x28, 0x09, 0x52, 0x08, 0x68, 0x6f, 0x73, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x1a, 0x8a, 0x01, 0x0a,
	...
	0x1c, 0x0a, 0x09, 0x6d, 0x75, 0x6c, 0x74, 0x69, 0x41, 0x64, 0x64, 0x72, 0x18, 0x03, 0x20, 0x01,
	...
	,
	...
	0x42, 0x10, 0x06, 0x42, 0x09, 0x5a, 0x07, 0x2f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x73, 0x62, 0x06,
...
var file_peer_proto_goTypes = []interface{}{
	...
	(*Linkers)(nil),                // 6: models.Linkers
	(*Lobby)(nil),                  // 7: models.Lobby
	(*Location)(nil),               // 8: models.Location
	(*Peer)(nil),                   // 9: models.Peer
	(*Position)(nil),               // 10: models.Position
	(*Profile)(nil),                // 11: models.Profile
	(*Topic)(nil),                  // 12: models.Topic
	nil,                            // 13: models.Lobby.PeersEntry
	(*Location_Placemark)(nil),     // 14: models.Location.Placemark
	(*Peer_ID)(nil),                // 15: models.Peer.ID
	(*Peer_Properties)(nil),        // 16: models.Peer.Properties
	(*Position_Accelerometer)(nil), // 17: models.Position.Accelerometer
	(*Position_Compass)(nil),       // 18: models.Position.Compass
	(*Position_Orientation)(nil),   // 19: models.Position.Orientation
}
var file_peer_proto_depIdxs = []int32{
	9,  // 0: models.Linkers.list:type_name -> models.Peer
	12, // 1: models.Lobby.topic:type_name -> models.Topic
	13, // 2: models.Lobby.peers:type_name -> models.Lobby.PeersEntry
	2,  // 3: models.Lobby.status:type_name -> models.Lobby.Status
	14, // 4: models.Location.placemark:type_name -> models.Location.Placemark
	15, // 5: models.Peer.id:type_name -> models.Peer.ID
	1,  // 6: models.Peer.platform:type_name -> models.Platform
	10, // 7: models.Peer.position:type_name -> models.Position
	11, // 8: models.Peer.profile:type_name -> models.Profile
	16, // 9: models.Peer.properties:type_name -> models.Peer.Properties
	3,  // 10: models.Peer.status:type_name -> models.Peer.Status
	18, // 11: models.Position.facing:type_name -> models.Position.Compass
	18, // 12: models.Position.heading:type_name -> models.Position.Compass
	4,  // 13: models.Position.proximity:type_name -> models.Position.Proximity
	17, // 14: models.Position.accelerometer:type_name -> models.Position.Accelerometer
	19, // 15: models.Position.orientation:type_name -> models.Position.Orientation
	1,  // 16: models.Profile.platform:type_name -> models.Platform
	5,  // 17: models.Topic.type:type_name -> models.Topic.Type
	9,  // 18: models.Lobby.PeersEntry.value:type_name -> models.Peer
	0,  // 19: models.Position.Compass.cardinal:type_name -> models.Cardinal
	0,  // 20: models.Position.Compass.antiCardinal:type_name -> models.Cardinal
