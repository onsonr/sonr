...
func (o *ConnectionResponse) ToGeneric() []byte {
	// Marshal Original
	ogBuf := o.Marshal()
	...
	// Marshal Generic
	genBuf := generic.Marshal()
	return genBuf
}

// Create New Generic INVITE Request Message
func (o *InviteRequest) ToGeneric() []byte {
	// Marshal Original
	ogBuf := o.Marshal()
...
func (o *InviteResponse) ToGeneric() []byte {
	// Marshal Original
	ogBuf := o.Marshal()
...
func (o *RestRequest) ToGeneric() []byte {
	// Marshal Original
	ogBuf := o.Marshal()
...
func (o *RestResponse) ToGeneric() []byte {
	// Marshal Original
	ogBuf := o.Marshal()
...
func (o *CompleteEvent) ToGeneric() []byte {
	// Marshal Original
	ogBuf := o.Marshal()
...
func (o *MailEvent) ToGeneric() []byte {
	// Marshal Original
	ogBuf := o.Marshal()
...
func (o *ProgressEvent) ToGeneric() []byte {
	// Marshal Original
	ogBuf := o.Marshal()
...
func (o *TopicEvent) ToGeneric() []byte {
	// Marshal Original
	ogBuf := o.Marshal()
