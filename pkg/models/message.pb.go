...
func (x *LobbyMessage) GetData() *Peer {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_message_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x63, 0x74, 0x52, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x63, 0x74, 0x22, 0x57, 0x0a,
	0x0c, 0x4c, 0x6f, 0x62, 0x62, 0x79, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x14, 0x0a,
	...
	0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x12, 0x19, 0x0a, 0x04, 0x64,
	0x61, 0x74, 0x61, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x05, 0x2e, 0x50, 0x65, 0x65, 0x72,
	0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0xba, 0x01, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x4d,
	...
	0x72, 0x12, 0x2e, 0x0a, 0x07, 0x73, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x18, 0x02, 0x20, 0x01,
...
var file_message_proto_goTypes = []interface{}{
	...
	(*ConnectedMessage)(nil), // 1: ConnectedMessage
	(*ErrorMessage)(nil),     // 2: ErrorMessage
	(*RequestMessage)(nil),   // 3: RequestMessage
	(*LobbyMessage)(nil),     // 4: LobbyMessage
...
var file_message_proto_depIdxs = []int32{
	6, // 0: ConnectedMessage.contact:type_name -> Contact
	7, // 1: ConnectedMessage.profile:type_name -> Profile
	6, // 2: RequestMessage.contact:type_name -> Contact
	8, // 3: LobbyMessage.data:type_name -> Peer
	8, // 4: AuthMessage.peer:type_name -> Peer
