...
var file_api_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x52, 0x06, 0x63, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x22, 0xfa, 0x01, 0x0a, 0x11, 0x43,
	...
	0x4b, 0x65, 0x79, 0x73, 0x52, 0x07, 0x61, 0x70, 0x69, 0x4b, 0x65, 0x79, 0x73, 0x22, 0x28, 0x0a,
	0x04, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0b, 0x0a, 0x07, 0x43, 0x4f, 0x4e, 0x4e, 0x45, 0x43, 0x54,
	0x10, 0x00, 0x12, 0x09, 0x0a, 0x05, 0x53, 0x54, 0x4f, 0x52, 0x4a, 0x10, 0x01, 0x12, 0x08, 0x0a,
	0x04, 0x4c, 0x49, 0x4e, 0x4b, 0x10, 0x02, 0x22, 0x49, 0x0a, 0x12, 0x43, 0x6f, 0x6e, 0x6e, 0x65,
	...
	0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0x9a, 0x01, 0x0a, 0x0d, 0x55, 0x70, 0x64,
	...
	0x04, 0x64, 0x61, 0x74, 0x61, 0x2a, 0x39, 0x0a, 0x0e, 0x52, 0x65, 0x73, 0x74, 0x4d, 0x65, 0x74,
	0x68, 0x6f, 0x64, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0b, 0x0a, 0x07, 0x44, 0x45, 0x46, 0x41, 0x55,
	0x4c, 0x54, 0x10, 0x00, 0x12, 0x07, 0x0a, 0x03, 0x47, 0x45, 0x54, 0x10, 0x01, 0x12, 0x07, 0x0a,
...
var file_api_proto_goTypes = []interface{}{
	...
	nil,                             // 14: RestRequest.ParametersEntry
	nil,                             // 15: RestResponse.BodyEntry
	(*Device)(nil),                  // 16: Device
	(*APIKeys)(nil),                 // 17: APIKeys
	(*User_Crypto)(nil),             // 18: User.Crypto
	(*Location)(nil),                // 19: Location
	(*Contact)(nil),                 // 20: Contact
	(*User)(nil),                    // 21: User
	(*Peer_ID)(nil),                 // 22: Peer.ID
	(Payload)(0),                    // 23: Payload
	(*Peer)(nil),                    // 24: Peer
	(*Transfer)(nil),                // 25: Transfer
	(Status)(0),                     // 26: Status
...
var file_api_proto_depIdxs = []int32{
	...
	16, // 1: AuthenticationRequest.device:type_name -> Device
	17, // 2: AuthenticationRequest.apiKeys:type_name -> APIKeys
	18, // 3: AuthenticationResponse.crypto:type_name -> User.Crypto
	2,  // 4: ConnectionRequest.type:type_name -> ConnectionRequest.Type
	19, // 5: ConnectionRequest.location:type_name -> Location
	16, // 6: ConnectionRequest.device:type_name -> Device
	20, // 7: ConnectionRequest.contact:type_name -> Contact
	17, // 8: ConnectionRequest.apiKeys:type_name -> APIKeys
	21, // 9: ConnectionResponse.user:type_name -> User
	22, // 10: ConnectionResponse.id:type_name -> Peer.ID
	23, // 11: InviteRequest.payload:type_name -> Payload
	24, // 12: InviteRequest.from:type_name -> Peer
	24, // 13: InviteRequest.to:type_name -> Peer
	25, // 14: InviteRequest.data:type_name -> Transfer
	3,  // 15: InviteResponse.type:type_name -> InviteResponse.Type
	24, // 16: InviteResponse.from:type_name -> Peer
	24, // 17: InviteResponse.to:type_name -> Peer
	25, // 18: InviteResponse.data:type_name -> Transfer
	0,  // 19: RestRequest.type:type_name -> RestMethodType
	14, // 20: RestRequest.parameters:type_name -> RestRequest.ParametersEntry
	24, // 21: RestRequest.peer:type_name -> Peer
	0,  // 22: RestResponse.type:type_name -> RestMethodType
	15, // 23: RestResponse.body:type_name -> RestResponse.BodyEntry
	26, // 24: StatusUpdate.value:type_name -> Status
	21, // 25: StatusUpdate.user:type_name -> User
	27, // 26: UpdateRequest.properties:type_name -> Peer.Properties
	20, // 27: UpdateRequest.contact:type_name -> Contact
	28, // 28: UpdateRequest.position:type_name -> Position
