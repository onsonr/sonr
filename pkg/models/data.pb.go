...
var file_data_proto_msgTypes = make([]protoimpl.MessageInfo, 32)
var file_data_proto_goTypes = []interface{}{
	...
	(*Lobby)(nil),                          // 11: Lobby
	(*LobbyEvent)(nil),                     // 12: LobbyEvent
	(*Location)(nil),                       // 13: Location
	(*MIME)(nil),                           // 14: MIME
	(*RemoteInfo)(nil),                     // 15: RemoteInfo
	(*SonrFile)(nil),                       // 16: SonrFile
...
var file_data_proto_depIdxs = []int32{
	...
	9,  // 17: SonrFile.direction:type_name -> SonrFile.Direction
	0,  // 18: TransferCard.payload:type_name -> Payload
	42, // 19: TransferCard.receiver:type_name -> Profile
	42, // 20: TransferCard.owner:type_name -> Profile
	10, // 21: TransferCard.contact:type_name -> Contact
	16, // 22: TransferCard.file:type_name -> SonrFile
	18, // 23: TransferCard.url:type_name -> URLLink
	34, // 24: URLLink.images:type_name -> URLLink.OpenGraphImage
	35, // 25: URLLink.videos:type_name -> URLLink.OpenGraphVideo
	36, // 26: URLLink.audios:type_name -> URLLink.OpenGraphAudio
	37, // 27: URLLink.twitter:type_name -> URLLink.TwitterCard
	23, // 28: Contact.AddressesEntry.value:type_name -> Contact.Address
	25, // 29: Contact.GeneralEntry.value:type_name -> Contact.Field
	26, // 30: Contact.SocialsEntry.value:type_name -> Contact.Social
	18, // 31: Contact.WebsitesEntry.value:type_name -> URLLink
	1,  // 32: Contact.Design.primary:type_name -> Contact.Design.Color
	1,  // 33: Contact.Design.accent:type_name -> Contact.Design.Color
	2,  // 34: Contact.Field.kind:type_name -> Contact.Field.Kind
	3,  // 35: Contact.Social.provider:type_name -> Contact.Social.Provider
	28, // 36: Contact.Social.tile:type_name -> Contact.Social.Tile
	27, // 37: Contact.Social.links:type_name -> Contact.Social.Links
	4,  // 38: Contact.Social.visibility:type_name -> Contact.Social.Visibility
	18, // 39: Contact.Social.Links.feedLink:type_name -> URLLink
	18, // 40: Contact.Social.Links.postLink:type_name -> URLLink
	18, // 41: Contact.Social.Links.profileLink:type_name -> URLLink
	5,  // 42: Contact.Social.Tile.type:type_name -> Contact.Social.Tile.Display
	43, // 43: Lobby.PeersEntry.value:type_name -> Peer
	14, // 44: SonrFile.Metadata.mime:type_name -> MIME
	33, // 45: SonrFile.Metadata.properties:type_name -> SonrFile.Metadata.Properties
	38, // 46: URLLink.TwitterCard.player:type_name -> URLLink.TwitterCard.Player
	39, // 47: URLLink.TwitterCard.iphone:type_name -> URLLink.TwitterCard.IPhone
	40, // 48: URLLink.TwitterCard.ipad:type_name -> URLLink.TwitterCard.IPad
	41, // 49: URLLink.TwitterCard.googlePlay:type_name -> URLLink.TwitterCard.GooglePlay
