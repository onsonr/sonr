...
type Lobby struct {
	...
	Groups map[string]*Group `protobuf:"bytes,5,rep,name=groups,proto3" json:"groups,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // Active User Groups
}
...
func (x *Lobby) GetGroups() map[string]*Group {
	if x != nil {
		return x.Groups
	}
	return nil
...
var file_data_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa1, 0x01, 0x0a, 0x05, 0x47, 0x72, 0x6f,
	...
	0x52, 0x07, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x73, 0x1a, 0x41, 0x0a, 0x0c, 0x4d, 0x65, 0x6d,
	...
	0x72, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x9c, 0x02, 0x0a,
	...
	0x6e, 0x74, 0x72, 0x79, 0x52, 0x05, 0x70, 0x65, 0x65, 0x72, 0x73, 0x12, 0x2a, 0x0a, 0x06, 0x67,
	0x72, 0x6f, 0x75, 0x70, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x4c, 0x6f,
	0x62, 0x62, 0x79, 0x2e, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52,
	0x06, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x1a, 0x3f, 0x0a, 0x0a, 0x50, 0x65, 0x65, 0x72, 0x73,
	...
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x41, 0x0a, 0x0b, 0x47, 0x72, 0x6f, 0x75,
	...
	0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x06, 0x2e, 0x47, 0x72, 0x6f, 0x75, 0x70,
...
var file_data_proto_depIdxs = []int32{
	...
	14, // 2: Lobby.groups:type_name -> Lobby.GroupsEntry
	2,  // 3: LobbyEvent.event:type_name -> LobbyEvent.Event
	25, // 4: LobbyEvent.data:type_name -> Peer
	9,  // 5: Metadata.mime:type_name -> MIME
	3,  // 6: MIME.type:type_name -> MIME.Type
	1,  // 7: TransferCard.payload:type_name -> Payload
	26, // 8: TransferCard.platform:type_name -> Platform
	16, // 9: TransferCard.progress:type_name -> TransferCard.Progress
	4,  // 10: TransferCard.status:type_name -> TransferCard.Status
	15, // 11: TransferCard.properties:type_name -> TransferCard.Properties
	27, // 12: TransferCard.contact:type_name -> Contact
	8,  // 13: TransferCard.metadata:type_name -> Metadata
	11, // 14: TransferCard.url:type_name -> URLLink
	17, // 15: URLLink.images:type_name -> URLLink.OpenGraphImage
	18, // 16: URLLink.videos:type_name -> URLLink.OpenGraphVideo
	19, // 17: URLLink.audios:type_name -> URLLink.OpenGraphAudio
	20, // 18: URLLink.twitter:type_name -> URLLink.TwitterCard
	25, // 19: Group.MembersEntry.value:type_name -> Peer
	25, // 20: Lobby.PeersEntry.value:type_name -> Peer
	5,  // 21: Lobby.GroupsEntry.value:type_name -> Group
	9,  // 22: TransferCard.Properties.mime:type_name -> MIME
	21, // 23: URLLink.TwitterCard.player:type_name -> URLLink.TwitterCard.Player
	22, // 24: URLLink.TwitterCard.iphone:type_name -> URLLink.TwitterCard.IPhone
	23, // 25: URLLink.TwitterCard.ipad:type_name -> URLLink.TwitterCard.IPad
	24, // 26: URLLink.TwitterCard.googlePlay:type_name -> URLLink.TwitterCard.GooglePlay
