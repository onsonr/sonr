...
type Metadata_Properties struct {
	...
	IsPhoto      bool    `protobuf:"varint,1,opt,name=isPhoto,proto3" json:"isPhoto,omitempty"`              // If File is Video
	IsImage      bool    `protobuf:"varint,2,opt,name=isImage,proto3" json:"isImage,omitempty"`              // If File is Video
...
func (x *Metadata_Properties) GetIsPhoto() bool {
	if x != nil {
		return x.IsPhoto
	}
	return false
...
var file_data_proto_rawDesc = []byte{
	...
	0x69, 0x73, 0x50, 0x68, 0x6f, 0x74, 0x6f, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x69,
	0x73, 0x50, 0x68, 0x6f, 0x74, 0x6f, 0x12, 0x18, 0x0a, 0x07, 0x69, 0x73, 0x49, 0x6d, 0x61, 0x67,
	...
	0x0b, 0x53, 0x50, 0x52, 0x45, 0x41, 0x44, 0x53, 0x48, 0x45, 0x45, 0x54, 0x10, 0x07, 0x42, 0x09,
