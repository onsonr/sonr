...
// CachedFile to be stored in Badger Store
...
func (x *CachedFile) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *CachedFile) GetMetadata() *Metadata {
	if x != nil {
		return x.Metadata
	}
	return nil
...
func (x *CachedFile) GetThumbnail() []byte {
	if x != nil {
		return x.Thumbnail
	}
	return nil
...
var file_data_proto_rawDesc = []byte{
	0x0a, 0x0a, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x72, 0x0a, 0x08,
	0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x16, 0x0a, 0x06, 0x66, 0x69, 0x6c, 0x65,
	...
	0x22, 0x61, 0x0a, 0x0a, 0x43, 0x61, 0x63, 0x68, 0x65, 0x64, 0x46, 0x69, 0x6c, 0x65, 0x12, 0x0e,
	...
	0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x1c, 0x0a, 0x09, 0x74, 0x68, 0x75, 0x6d, 0x62, 0x6e, 0x61,
...
var file_data_proto_goTypes = []interface{}{
	...
	(*CachedFile)(nil), // 1: CachedFile
}
var file_data_proto_depIdxs = []int32{
	0, // 0: CachedFile.metadata:type_name -> Metadata
