...
export interface QueryDidByPubKeyRequest {
}

export interface QueryDidByPubKeyResponse {
}
...
function createBaseQueryDidByPubKeyRequest(): QueryDidByPubKeyRequest {
  return {};
}

export const QueryDidByPubKeyRequest = {
  encode(_: QueryDidByPubKeyRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): QueryDidByPubKeyRequest {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryDidByPubKeyRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromJSON(_: any): QueryDidByPubKeyRequest {
    return {};
  },

  toJSON(_: QueryDidByPubKeyRequest): unknown {
    const obj: any = {};
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<QueryDidByPubKeyRequest>, I>>(_: I): QueryDidByPubKeyRequest {
    const message = createBaseQueryDidByPubKeyRequest();
    return message;
  },
};

function createBaseQueryDidByPubKeyResponse(): QueryDidByPubKeyResponse {
  return {};
}

export const QueryDidByPubKeyResponse = {
  encode(_: QueryDidByPubKeyResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): QueryDidByPubKeyResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryDidByPubKeyResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromJSON(_: any): QueryDidByPubKeyResponse {
    return {};
  },

  toJSON(_: QueryDidByPubKeyResponse): unknown {
    const obj: any = {};
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<QueryDidByPubKeyResponse>, I>>(_: I): QueryDidByPubKeyResponse {
    const message = createBaseQueryDidByPubKeyResponse();
    return message;
  },
};
...
export interface Query {
  ...
  DidByPubKey(request: QueryDidByPubKeyRequest): Promise<QueryDidByPubKeyResponse>;
}
...
export class QueryClientImpl implements Query {
  ...
  constructor(rpc: Rpc) {
    ...
    this.DidByPubKey = this.DidByPubKey.bind(this);
  }
  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    const data = QueryParamsRequest.encode(request).finish();
    const promise = this.rpc.request("sonrhq.core.identity.Query", "Params", data);
    return promise.then((data) => QueryParamsResponse.decode(new _m0.Reader(data)));
  }

  Did(request: QueryGetDidRequest): Promise<QueryGetDidResponse> {
    const data = QueryGetDidRequest.encode(request).finish();
    const promise = this.rpc.request("sonrhq.core.identity.Query", "Did", data);
  ...
  DidByKeyID(request: QueryDidByKeyIDRequest): Promise<QueryDidByKeyIDResponse> {
    ...
    const promise = this.rpc.request("sonrhq.core.identity.Query", "DidByKeyID", data);
  ...
  DidByAlsoKnownAs(request: QueryDidByAlsoKnownAsRequest): Promise<QueryDidByAlsoKnownAsResponse> {
    ...
    const promise = this.rpc.request("sonrhq.core.identity.Query", "DidByAlsoKnownAs", data);
  ...
  DidAll(request: QueryAllDidRequest): Promise<QueryAllDidResponse> {
    ...
    const promise = this.rpc.request("sonrhq.core.identity.Query", "DidAll", data);
  ...
  Service(request: QueryGetServiceRequest): Promise<QueryGetServiceResponse> {
    ...
    const promise = this.rpc.request("sonrhq.core.identity.Query", "Service", data);
  ...
  ServiceAll(request: QueryAllServiceRequest): Promise<QueryAllServiceResponse> {
    ...
    const promise = this.rpc.request("sonrhq.core.identity.Query", "ServiceAll", data);
    return promise.then((data) => QueryAllServiceResponse.decode(new _m0.Reader(data)));
  }

  DidByPubKey(request: QueryDidByPubKeyRequest): Promise<QueryDidByPubKeyResponse> {
    const data = QueryDidByPubKeyRequest.encode(request).finish();
    const promise = this.rpc.request("sonrhq.core.identity.Query", "DidByPubKey", data);
    return promise.then((data) => QueryDidByPubKeyResponse.decode(new _m0.Reader(data)));
  }
}
