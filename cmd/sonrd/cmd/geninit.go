...
import (
	...
	"github.com/sonrhq/core/cmd/sonrd/config"
...
func InitCmd(mbm module.BasicManager, defaultNodeHome string) *cobra.Command {
	...
	cmd.Flags().String(flags.FlagChainID, config.EnvChainID(), "genesis file chain-id, if left blank will be randomly created")
