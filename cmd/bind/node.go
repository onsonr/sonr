...
func Initialize(reqBytes []byte, call Callback) *Client {
	// // Unmarshal Request
...
func (n *Client) Connect(buf []byte) {
	// // Unmarshal Request
...
func (n *Client) setConnected(val bool) {
	// // Update Status
...
func (n *Client) setAvailable(val bool) {
	// // Update Status
