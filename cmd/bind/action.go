...
func (n *Client) Sign(buf []byte) []byte {
...
func (n *Client) Verify(buf []byte) []byte {
	// // Check Read
	// // Get Key Pair
...
func (n *Client) Invite(buf []byte) {
	...
	// func (n *Client) Link(buf []byte) []byte {
	// 	// Unmarshal Data to Request
...
func (n *Client) Mail(buf []byte) []byte {
	// // Unmarshal Data to Request
...
func (n *Client) Respond(buf []byte) {
	// // Unmarshal Data to Request
...
func (s *Client) Action(buf []byte) []byte {
	// // Unmarshal Data to Request
