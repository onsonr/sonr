#!/bin/sh
set -e
# Code generated by godownloader on 2024-02-05T10:40:36Z. DO NOT EDIT.
#

usage() {
  this=$1
  cat <<EOF
$this: download go binaries for didao-org/sonr

Usage: $this [-b] bindir [-d] [tag]
  -b sets bindir or installation directory, Defaults to ./bin
  -d turns on debug logging
   [tag] is a tag from
   https://github.com/didao-org/sonr/releases
