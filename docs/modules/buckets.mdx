...
- Read [ADR-3](https://github.com/sonr-hq/sonr/blob/dev/docs/architecture/3.md) for a more in depth technical explanation of the design decisions made for the bucket module.
