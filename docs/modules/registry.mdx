...
- Read [ADR-1](https://github.com/sonr-hq/sonr/blob/dev/docs/architecture/1.md) for a more in depth technical explanation of the design decisions made for the registry module.
