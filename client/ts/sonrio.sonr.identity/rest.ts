...
export type IdentityMsgUpdateDidDocumentResponse = object;
...
export interface IdentityQueryAllDidDocumentResponse {
...
export interface IdentityQueryGetDidDocumentResponse {
  didDocument?: IdentityDidDocument;
}
...
export interface IdentityService {
  ...
  /** optional */
  service_endpoint_map?: IdentityKeyValuePair[];
}
...
/**
 * @title sonr/identity/did_document.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   *
   * @tags Query
   * @name QueryDidDocumentAll
   * @summary Queries a list of DidDocument items.
   * @request GET:/sonr-io/sonr/identity/did_document
   */
  queryDidDocumentAll = (
    query?: {
    ...
    this.request<IdentityQueryAllDidDocumentResponse, RpcStatus>({
      path: `/sonr-io/sonr/identity/did_document`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/sonr-io/sonr/identity/did_document/{did}
   */
  queryDidDocument = (did: string, params: RequestParams = {}) =>
    this.request<IdentityQueryGetDidDocumentResponse, RpcStatus>({
      path: `/sonr-io/sonr/identity/did_document/${did}`,
      method: "GET",
      format: "json",
      ...params,
    });
