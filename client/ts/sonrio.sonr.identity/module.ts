...
export { MsgDeleteDidDocument, MsgCreateDidDocument, MsgUpdateDidDocument };
...
export const txClient = ({ signer, prefix, addr }: TxClientOptions = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
  ...
  return {
		...
		msgDeleteDidDocument({ value }: msgDeleteDidDocumentParams): EncodeObject {
			try {
				return { typeUrl: "/sonrio.sonr.identity.MsgDeleteDidDocument", value: MsgDeleteDidDocument.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgCreateDidDocument({ value }: msgCreateDidDocumentParams): EncodeObject {
			try {
				return { typeUrl: "/sonrio.sonr.identity.MsgCreateDidDocument", value: MsgCreateDidDocument.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgUpdateDidDocument({ value }: msgUpdateDidDocumentParams): EncodeObject {
			try {
				return { typeUrl: "/sonrio.sonr.identity.MsgUpdateDidDocument", value: MsgUpdateDidDocument.fromPartial( value ) }  
			} catch (e: any) {
...
const Module = (test: IgniteClient) => {
	return {
		module: {
			SonrioSonrIdentity: new SDKModule(test)
		},
		registry: msgTypes
  }
}
