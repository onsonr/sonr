...
export interface InitializeRequest {
  ...
  /** Libp2p Host config */
  hostOptions: InitializeRequest_HostOptions | undefined;
  /** Service Config */
  serviceOptions: InitializeRequest_ServiceOptions | undefined;
  /** File System Config */
  deviceOptions: InitializeRequest_DeviceOptions | undefined;
  /** Environment Config */
...
export const InitializeRequest = {
  encode(
    ...
    if (message.connection !== 0) {
      writer.uint32(24).int32(message.connection);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.connection = reader.int32() as any;
          break;
        case 4:
...
function createBaseInitializeRequest_IPAddress(): InitializeRequest_IPAddress {
  return { name: "", address: "", internal: false, family: 0 };
}
...
export const InitializeRequest_IPAddress = {
  encode(
    ...
    if (message.family !== 0) {
      writer.uint32(32).int32(message.family);
    }
    return writer;
  },
