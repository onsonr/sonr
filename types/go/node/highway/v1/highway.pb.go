...
var file_node_highway_v1_highway_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xff, 0x18,
	...
	0x6c, 0x76, 0x65, 0x12, 0x6a, 0x0a, 0x09, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x44, 0x69, 0x64,
	0x12, 0x21, 0x2e, 0x6e, 0x6f, 0x64, 0x65, 0x2e, 0x68, 0x69, 0x67, 0x68, 0x77, 0x61, 0x79, 0x2e,
	0x76, 0x31, 0x2e, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x44, 0x69, 0x64, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x22, 0x2e, 0x6e, 0x6f, 0x64, 0x65, 0x2e, 0x68, 0x69, 0x67, 0x68, 0x77,
	0x61, 0x79, 0x2e, 0x76, 0x31, 0x2e, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x44, 0x69, 0x64, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x16, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x10, 0x22,
	0x0e, 0x2f, 0x76, 0x31, 0x2f, 0x64, 0x69, 0x64, 0x2f, 0x76, 0x65, 0x72, 0x69, 0x66, 0x79, 0x42,
...
var file_node_highway_v1_highway_proto_goTypes = []interface{}{
	...
	(*AccessNameResponse)(nil),      // 27: node.highway.v1.AccessNameResponse
	(*RegisterNameResponse)(nil),    // 28: node.highway.v1.RegisterNameResponse
	(*UpdateNameResponse)(nil),      // 29: node.highway.v1.UpdateNameResponse
	(*AccessServiceResponse)(nil),   // 30: node.highway.v1.AccessServiceResponse
	(*RegisterServiceResponse)(nil), // 31: node.highway.v1.RegisterServiceResponse
	(*UpdateServiceResponse)(nil),   // 32: node.highway.v1.UpdateServiceResponse
	(*CreateChannelResponse)(nil),   // 33: node.highway.v1.CreateChannelResponse
	(*ReadChannelResponse)(nil),     // 34: node.highway.v1.ReadChannelResponse
	(*UpdateChannelResponse)(nil),   // 35: node.highway.v1.UpdateChannelResponse
	(*DeleteChannelResponse)(nil),   // 36: node.highway.v1.DeleteChannelResponse
	(*ListenChannelResponse)(nil),   // 37: node.highway.v1.ListenChannelResponse
	(*CreateBucketResponse)(nil),    // 38: node.highway.v1.CreateBucketResponse
	(*ReadBucketResponse)(nil),      // 39: node.highway.v1.ReadBucketResponse
	(*UpdateBucketResponse)(nil),    // 40: node.highway.v1.UpdateBucketResponse
	(*DeleteBucketResponse)(nil),    // 41: node.highway.v1.DeleteBucketResponse
	(*ListenBucketResponse)(nil),    // 42: node.highway.v1.ListenBucketResponse
	(*CreateObjectResponse)(nil),    // 43: node.highway.v1.CreateObjectResponse
	(*ReadObjectResponse)(nil),      // 44: node.highway.v1.ReadObjectResponse
	(*UpdateObjectResponse)(nil),    // 45: node.highway.v1.UpdateObjectResponse
	(*DeleteObjectResponse)(nil),    // 46: node.highway.v1.DeleteObjectResponse
	(*UploadBlobResponse)(nil),      // 47: node.highway.v1.UploadBlobResponse
	(*DownloadBlobResponse)(nil),    // 48: node.highway.v1.DownloadBlobResponse
	(*SyncBlobResponse)(nil),        // 49: node.highway.v1.SyncBlobResponse
	(*DeleteBlobResponse)(nil),      // 50: node.highway.v1.DeleteBlobResponse
	(*ParseDidResponse)(nil),        // 51: node.highway.v1.ParseDidResponse
	(*ResolveDidResponse)(nil),      // 52: node.highway.v1.ResolveDidResponse
	(*VerifyDidResponse)(nil),       // 53: node.highway.v1.VerifyDidResponse
}
var file_node_highway_v1_highway_proto_depIdxs = []int32{
	...
	26, // 26: node.highway.v1.HighwayService.VerifyDid:input_type -> node.highway.v1.VerifyDidRequest
	27, // 27: node.highway.v1.HighwayService.AccessName:output_type -> node.highway.v1.AccessNameResponse
	28, // 28: node.highway.v1.HighwayService.RegisterName:output_type -> node.highway.v1.RegisterNameResponse
	29, // 29: node.highway.v1.HighwayService.UpdateName:output_type -> node.highway.v1.UpdateNameResponse
	30, // 30: node.highway.v1.HighwayService.AccessService:output_type -> node.highway.v1.AccessServiceResponse
	31, // 31: node.highway.v1.HighwayService.RegisterService:output_type -> node.highway.v1.RegisterServiceResponse
	32, // 32: node.highway.v1.HighwayService.UpdateService:output_type -> node.highway.v1.UpdateServiceResponse
	33, // 33: node.highway.v1.HighwayService.CreateChannel:output_type -> node.highway.v1.CreateChannelResponse
	34, // 34: node.highway.v1.HighwayService.ReadChannel:output_type -> node.highway.v1.ReadChannelResponse
	35, // 35: node.highway.v1.HighwayService.UpdateChannel:output_type -> node.highway.v1.UpdateChannelResponse
	36, // 36: node.highway.v1.HighwayService.DeleteChannel:output_type -> node.highway.v1.DeleteChannelResponse
	37, // 37: node.highway.v1.HighwayService.ListenChannel:output_type -> node.highway.v1.ListenChannelResponse
	38, // 38: node.highway.v1.HighwayService.CreateBucket:output_type -> node.highway.v1.CreateBucketResponse
	39, // 39: node.highway.v1.HighwayService.ReadBucket:output_type -> node.highway.v1.ReadBucketResponse
	40, // 40: node.highway.v1.HighwayService.UpdateBucket:output_type -> node.highway.v1.UpdateBucketResponse
	41, // 41: node.highway.v1.HighwayService.DeleteBucket:output_type -> node.highway.v1.DeleteBucketResponse
	42, // 42: node.highway.v1.HighwayService.ListenBucket:output_type -> node.highway.v1.ListenBucketResponse
	43, // 43: node.highway.v1.HighwayService.CreateObject:output_type -> node.highway.v1.CreateObjectResponse
	44, // 44: node.highway.v1.HighwayService.ReadObject:output_type -> node.highway.v1.ReadObjectResponse
	45, // 45: node.highway.v1.HighwayService.UpdateObject:output_type -> node.highway.v1.UpdateObjectResponse
	46, // 46: node.highway.v1.HighwayService.DeleteObject:output_type -> node.highway.v1.DeleteObjectResponse
	47, // 47: node.highway.v1.HighwayService.UploadBlob:output_type -> node.highway.v1.UploadBlobResponse
	48, // 48: node.highway.v1.HighwayService.DownloadBlob:output_type -> node.highway.v1.DownloadBlobResponse
	49, // 49: node.highway.v1.HighwayService.SyncBlob:output_type -> node.highway.v1.SyncBlobResponse
	50, // 50: node.highway.v1.HighwayService.DeleteBlob:output_type -> node.highway.v1.DeleteBlobResponse
	51, // 51: node.highway.v1.HighwayService.ParseDid:output_type -> node.highway.v1.ParseDidResponse
	52, // 52: node.highway.v1.HighwayService.ResolveDid:output_type -> node.highway.v1.ResolveDidResponse
	53, // 53: node.highway.v1.HighwayService.VerifyDid:output_type -> node.highway.v1.VerifyDidResponse
