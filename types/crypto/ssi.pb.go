...
func init() {
	proto.RegisterEnum("sonr.crypto.KeyType", KeyType_name, KeyType_value)
	proto.RegisterEnum("sonr.crypto.ProofType", ProofType_name, ProofType_value)
	proto.RegisterType((*Proof)(nil), "sonr.crypto.Proof")
	proto.RegisterType((*JSONWebSignature2020Proof)(nil), "sonr.crypto.JSONWebSignature2020Proof")
	proto.RegisterType((*VerifiableCredential)(nil), "sonr.crypto.VerifiableCredential")
	proto.RegisterMapType((map[string]string)(nil), "sonr.crypto.VerifiableCredential.CredentialSubjectEntry")
	proto.RegisterMapType((map[string]string)(nil), "sonr.crypto.VerifiableCredential.ProofEntry")
}
...
var fileDescriptor_0ffa4774452f710f = []byte{
	...
	,
}
