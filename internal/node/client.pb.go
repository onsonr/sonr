...
var file_proto_node_client_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x07, 0x0a, 0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x32, 0xe2, 0x06,
...
var file_proto_node_client_proto_goTypes = []interface{}{
	...
	(*common.DecisionEvent)(nil), // 16: sonr.core.DecisionEvent
	(*common.InviteEvent)(nil),   // 17: sonr.core.InviteEvent
	(*common.ProgressEvent)(nil), // 18: sonr.core.ProgressEvent
	(*common.CompleteEvent)(nil), // 19: sonr.core.CompleteEvent
}
var file_proto_node_client_proto_depIdxs = []int32{
	...
	8,  // 13: sonr.node.ClientService.Supply:output_type -> sonr.node.SupplyResponse
	9,  // 14: sonr.node.ClientService.Edit:output_type -> sonr.node.EditResponse
	10, // 15: sonr.node.ClientService.Fetch:output_type -> sonr.node.FetchResponse
	11, // 16: sonr.node.ClientService.Share:output_type -> sonr.node.ShareResponse
	12, // 17: sonr.node.ClientService.Respond:output_type -> sonr.node.RespondResponse
	13, // 18: sonr.node.ClientService.Search:output_type -> sonr.node.SearchResponse
	14, // 19: sonr.node.ClientService.Stat:output_type -> sonr.node.StatResponse
	15, // 20: sonr.node.ClientService.OnLobbyRefresh:output_type -> sonr.core.RefreshEvent
	16, // 21: sonr.node.ClientService.OnTransferAccepted:output_type -> sonr.core.DecisionEvent
	16, // 22: sonr.node.ClientService.OnTransferDeclined:output_type -> sonr.core.DecisionEvent
	17, // 23: sonr.node.ClientService.OnTransferInvite:output_type -> sonr.core.InviteEvent
	18, // 24: sonr.node.ClientService.OnTransferProgress:output_type -> sonr.core.ProgressEvent
	19, // 25: sonr.node.ClientService.OnTransferComplete:output_type -> sonr.core.CompleteEvent
