...
var file_proto_client_rpc_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x07, 0x0a, 0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x32, 0xe4,
	0x05, 0x0a, 0x0b, 0x4e, 0x6f, 0x64, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3f,
	...
	0x75, 0x73, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x22, 0x00, 0x30, 0x01, 0x12, 0x44, 0x0a, 0x12, 0x4f,
...
var file_proto_client_rpc_proto_depIdxs = []int32{
	...
	0,  // 6: sonr.node.NodeService.OnTransferAccepted:input_type -> sonr.node.Empty
	0,  // 7: sonr.node.NodeService.OnTransferDeclined:input_type -> sonr.node.Empty
	0,  // 8: sonr.node.NodeService.OnTransferInvite:input_type -> sonr.node.Empty
	0,  // 9: sonr.node.NodeService.OnTransferProgress:input_type -> sonr.node.Empty
	0,  // 10: sonr.node.NodeService.OnTransferComplete:input_type -> sonr.node.Empty
	6,  // 11: sonr.node.NodeService.Supply:output_type -> sonr.node.SupplyResponse
	7,  // 12: sonr.node.NodeService.Edit:output_type -> sonr.node.EditResponse
	8,  // 13: sonr.node.NodeService.Share:output_type -> sonr.node.ShareResponse
	9,  // 14: sonr.node.NodeService.Respond:output_type -> sonr.node.RespondResponse
	10, // 15: sonr.node.NodeService.Search:output_type -> sonr.node.SearchResponse
	11, // 16: sonr.node.NodeService.OnNodeStatus:output_type -> sonr.core.StatusEvent
	12, // 17: sonr.node.NodeService.OnTransferAccepted:output_type -> sonr.core.DecisionEvent
	12, // 18: sonr.node.NodeService.OnTransferDeclined:output_type -> sonr.core.DecisionEvent
	13, // 19: sonr.node.NodeService.OnTransferInvite:output_type -> sonr.core.InviteEvent
	14, // 20: sonr.node.NodeService.OnTransferProgress:output_type -> sonr.core.ProgressEvent
	15, // 21: sonr.node.NodeService.OnTransferComplete:output_type -> sonr.core.CompleteEvent
