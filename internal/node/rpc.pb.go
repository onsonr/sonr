...
var file_proto_client_rpc_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x07, 0x0a, 0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x32, 0xff,
	0x03, 0x0a, 0x0b, 0x4e, 0x6f, 0x64, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3f,
	...
	0x6e, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x3c, 0x0a, 0x0a,
	0x4f, 0x6e, 0x44, 0x65, 0x63, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x10, 0x2e, 0x73, 0x6f, 0x6e,
	...
	0x6e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x22, 0x00, 0x30, 0x01, 0x12, 0x38, 0x0a, 0x08, 0x4f, 0x6e,
	...
	0x22, 0x00, 0x30, 0x01, 0x12, 0x3c, 0x0a, 0x0a, 0x4f, 0x6e, 0x50, 0x72, 0x6f, 0x67, 0x72, 0x65,
	...
	0x30, 0x01, 0x12, 0x3c, 0x0a, 0x0a, 0x4f, 0x6e, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65,
...
var file_proto_client_rpc_proto_goTypes = []interface{}{
	...
	(*common.DecisionEvent)(nil), // 9: sonr.core.DecisionEvent
	(*common.InviteEvent)(nil),   // 10: sonr.core.InviteEvent
	(*common.ProgressEvent)(nil), // 11: sonr.core.ProgressEvent
	(*common.CompleteEvent)(nil), // 12: sonr.core.CompleteEvent
}
var file_proto_client_rpc_proto_depIdxs = []int32{
	...
	0,  // 4: sonr.node.NodeService.OnDecision:input_type -> sonr.node.Empty
	0,  // 5: sonr.node.NodeService.OnInvite:input_type -> sonr.node.Empty
	0,  // 6: sonr.node.NodeService.OnProgress:input_type -> sonr.node.Empty
	0,  // 7: sonr.node.NodeService.OnComplete:input_type -> sonr.node.Empty
	5,  // 8: sonr.node.NodeService.Supply:output_type -> sonr.node.SupplyResponse
	6,  // 9: sonr.node.NodeService.Edit:output_type -> sonr.node.EditResponse
	7,  // 10: sonr.node.NodeService.Share:output_type -> sonr.node.ShareResponse
	8,  // 11: sonr.node.NodeService.Respond:output_type -> sonr.node.RespondResponse
	9,  // 12: sonr.node.NodeService.OnDecision:output_type -> sonr.core.DecisionEvent
	10, // 13: sonr.node.NodeService.OnInvite:output_type -> sonr.core.InviteEvent
	11, // 14: sonr.node.NodeService.OnProgress:output_type -> sonr.core.ProgressEvent
	12, // 15: sonr.node.NodeService.OnComplete:output_type -> sonr.core.CompleteEvent
