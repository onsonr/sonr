...
const (
	Peer_AVAILABLE Peer_Status = 0
	Peer_BUSY      Peer_Status = 1
	Peer_STANDBY   Peer_Status = 2
)
...
type Lobby struct {
	...
	Available   map[string]*Peer `protobuf:"bytes,3,rep,name=available,proto3" json:"available,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Unavailable map[string]*Peer `protobuf:"bytes,4,rep,name=unavailable,proto3" json:"unavailable,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *Lobby) GetAvailable() map[string]*Peer {
	if x != nil {
		return x.Available
	}
	return nil
...
func (x *Lobby) GetUnavailable() map[string]*Peer {
	if x != nil {
...
type Peer struct {
	...
	Status     Peer_Status    `protobuf:"varint,2,opt,name=status,proto3,enum=Peer_Status" json:"status,omitempty"`
	...
	ProfilePic []byte         `protobuf:"bytes,7,opt,name=profilePic,proto3" json:"profilePic,omitempty"`
	Direction  float64        `protobuf:"fixed64,8,opt,name=direction,proto3" json:"direction,omitempty"`
	Difference float64        `protobuf:"fixed64,9,opt,name=difference,proto3" json:"difference,omitempty"`
...
var file_data_proto_rawDesc = []byte{
	...
	0x05, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x10, 0x04, 0x22, 0xab, 0x02, 0x0a, 0x05, 0x4c, 0x6f, 0x62,
	...
	,
	...
	0x45, 0x0a, 0x10, 0x55, 0x6e, 0x61, 0x76, 0x61, 0x69, 0x6c, 0x61, 0x62, 0x6c, 0x65, 0x45, 0x6e,
	...
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xe6, 0x04, 0x0a, 0x07, 0x43, 0x6f, 0x6e, 0x74, 0x61,
	...
	0x6e, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x77, 0x65, 0x62, 0x73, 0x69, 0x74, 0x65, 0x18, 0x04, 0x20,
	...
	0x69, 0x6c, 0x12, 0x1e, 0x0a, 0x0a, 0x70, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x50, 0x69, 0x63,
	0x18, 0x06, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0a, 0x70, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x50,
	0x69, 0x63, 0x12, 0x16, 0x0a, 0x06, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x18, 0x07, 0x20, 0x01,
	...
	0x52, 0x07, 0x73, 0x6f, 0x63, 0x69, 0x61, 0x6c, 0x73, 0x1a, 0xf3, 0x02, 0x0a, 0x0a, 0x53, 0x6f,
	0x63, 0x69, 0x61, 0x6c, 0x54, 0x69, 0x6c, 0x65, 0x12, 0x38, 0x0a, 0x08, 0x70, 0x72, 0x6f, 0x76,
	0x69, 0x64, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1c, 0x2e, 0x43, 0x6f, 0x6e,
	...
	0x6c, 0x54, 0x69, 0x6c, 0x65, 0x2e, 0x54, 0x69, 0x6c, 0x65, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x2c,
	0x0a, 0x08, 0x54, 0x69, 0x6c, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12, 0x08, 0x0a, 0x04, 0x49, 0x63,
	0x6f, 0x6e, 0x10, 0x00, 0x12, 0x08, 0x0a, 0x04, 0x46, 0x65, 0x65, 0x64, 0x10, 0x01, 0x12, 0x0c,
	0x0a, 0x08, 0x53, 0x68, 0x6f, 0x77, 0x63, 0x61, 0x73, 0x65, 0x10, 0x02, 0x22, 0x80, 0x01, 0x0a,
	...
	0x7a, 0x0a, 0x06, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x6c, 0x61,
	0x74, 0x66, 0x6f, 0x72, 0x6d, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x70, 0x6c, 0x61,
	0x74, 0x66, 0x6f, 0x72, 0x6d, 0x12, 0x14, 0x0a, 0x05, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x18, 0x02,
	...
	0x18, 0x05, 0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x73, 0x64, 0x6b, 0x22, 0x63, 0x0a, 0x0b, 0x44,
	...
	,
	...
	0x01, 0x28, 0x09, 0x52, 0x09, 0x64, 0x69, 0x73, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x79, 0x12, 0x1a,
	...
	,
	...
	0x45, 0x41, 0x52, 0x10, 0x02, 0x12, 0x07, 0x0a, 0x03, 0x46, 0x41, 0x52, 0x10, 0x03, 0x22, 0x2e,
	0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x0d, 0x0a, 0x09, 0x41, 0x56, 0x41, 0x49,
	0x4c, 0x41, 0x42, 0x4c, 0x45, 0x10, 0x00, 0x12, 0x08, 0x0a, 0x04, 0x42, 0x55, 0x53, 0x59, 0x10,
	0x01, 0x12, 0x0b, 0x0a, 0x07, 0x53, 0x54, 0x41, 0x4e, 0x44, 0x42, 0x59, 0x10, 0x02, 0x42, 0x0a,
...
var file_data_proto_goTypes = []interface{}{
	...
	(*Peer)(nil),                     // 11: Peer
	nil,                              // 12: Lobby.AvailableEntry
	nil,                              // 13: Lobby.UnavailableEntry
	(*Contact_SocialTile)(nil),       // 14: Contact.SocialTile
}
var file_data_proto_depIdxs = []int32{
	6,  // 0: Metadata.mime:type_name -> MIME
	11, // 1: Metadata.owner:type_name -> Peer
	0,  // 2: MIME.type:type_name -> MIME.Type
	12, // 3: Lobby.available:type_name -> Lobby.AvailableEntry
	13, // 4: Lobby.unavailable:type_name -> Lobby.UnavailableEntry
	14, // 5: Contact.socials:type_name -> Contact.SocialTile
	4,  // 6: Peer.status:type_name -> Peer.Status
	9,  // 7: Peer.device:type_name -> Device
	3,  // 8: Peer.proximity:type_name -> Peer.Proximity
	11, // 9: Lobby.AvailableEntry.value:type_name -> Peer
	11, // 10: Lobby.UnavailableEntry.value:type_name -> Peer
	2,  // 11: Contact.SocialTile.provider:type_name -> Contact.SocialTile.Provider
	1,  // 12: Contact.SocialTile.type:type_name -> Contact.SocialTile.TileType
