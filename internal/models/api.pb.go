...
// Enum for Type of Transfer
type ProcessRequest_ProcessType int32

const (
	ProcessRequest_Unknown       ProcessRequest_ProcessType = 0 // Default Value, Would not Transfer
	ProcessRequest_File          ProcessRequest_ProcessType = 1 // Media or Document
	ProcessRequest_MultiFiles    ProcessRequest_ProcessType = 2 // Multiple Media or Documents
	ProcessRequest_ExternalMedia ProcessRequest_ProcessType = 3 // Shared from Mobile Gallery
)

// Enum value maps for ProcessRequest_ProcessType.
var (
	ProcessRequest_ProcessType_name = map[int32]string{
		0: "Unknown",
		1: "File",
		2: "MultiFiles",
		3: "ExternalMedia",
	}
	ProcessRequest_ProcessType_value = map[string]int32{
		"Unknown":       0,
		"File":          1,
		"MultiFiles":    2,
		"ExternalMedia": 3,
...
func (x ProcessRequest_ProcessType) Enum() *ProcessRequest_ProcessType {
	p := new(ProcessRequest_ProcessType)
	*p = x
	return p
}

func (x ProcessRequest_ProcessType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ProcessRequest_ProcessType) Descriptor() protoreflect.EnumDescriptor {
	return file_api_proto_enumTypes[1].Descriptor()
}

func (ProcessRequest_ProcessType) Type() protoreflect.EnumType {
	return &file_api_proto_enumTypes[1]
}

func (x ProcessRequest_ProcessType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ProcessRequest_ProcessType.Descriptor instead.
func (ProcessRequest_ProcessType) EnumDescriptor() ([]byte, []int) {
...
// For Pre Invite File PRocessing
type ProcessRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Files []*ProcessRequest_FileInfo `protobuf:"bytes,1,rep,name=files,proto3" json:"files,omitempty"` // Files to be Sent
}
...
func (x *ProcessRequest) GetFiles() []*ProcessRequest_FileInfo {
	if x != nil {
		return x.Files
	}
	return nil
...
// FileInfo Message for Attached Files
type ProcessRequest_FileInfo struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ProcessRequest_FileInfo) Reset() {
	*x = ProcessRequest_FileInfo{}
	if protoimpl.UnsafeEnabled {
...
func (x *ProcessRequest_FileInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProcessRequest_FileInfo) ProtoMessage() {}

func (x *ProcessRequest_FileInfo) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProcessRequest_FileInfo.ProtoReflect.Descriptor instead.
func (*ProcessRequest_FileInfo) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{2, 0}
}

func (x *ProcessRequest_FileInfo) GetPath() string {
	if x != nil {
		return x.Path
	}
	return ""
...
func (x *ProcessRequest_FileInfo) GetHasThumbnail() bool {
	if x != nil {
		return x.HasThumbnail
	}
	return false
...
func (x *ProcessRequest_FileInfo) GetThumbpath() string {
	if x != nil {
		return x.Thumbpath
	}
	return ""
...
func (x *ProcessRequest_FileInfo) GetDuration() int32 {
	if x != nil {
		return x.Duration
	}
	return 0
...
var file_api_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x81, 0x02, 0x0a, 0x11, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69,
	...
	,
	...
	0x61, 0x63, 0x74, 0x12, 0x2d, 0x0a, 0x05, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x18, 0x06, 0x20, 0x03,
	...
	0x65, 0x73, 0x1a, 0x7c, 0x0a, 0x08, 0x46, 0x69, 0x6c, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x12,
	0x0a, 0x04, 0x70, 0x61, 0x74, 0x68, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x61,
	0x74, 0x68, 0x12, 0x22, 0x0a, 0x0c, 0x68, 0x61, 0x73, 0x54, 0x68, 0x75, 0x6d, 0x62, 0x6e, 0x61,
	0x69, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0c, 0x68, 0x61, 0x73, 0x54, 0x68, 0x75,
	0x6d, 0x62, 0x6e, 0x61, 0x69, 0x6c, 0x12, 0x1c, 0x0a, 0x09, 0x74, 0x68, 0x75, 0x6d, 0x62, 0x70,
	0x61, 0x74, 0x68, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x74, 0x68, 0x75, 0x6d, 0x62,
	...
	,
	...
	0x72, 0x43, 0x61, 0x72, 0x64, 0x52, 0x04, 0x63, 0x61, 0x72, 0x64, 0x12, 0x1a, 0x0a, 0x08, 0x69,
	0x73, 0x44, 0x69, 0x72, 0x65, 0x63, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x69,
	0x73, 0x44, 0x69, 0x72, 0x65, 0x63, 0x74, 0x22, 0x89, 0x01, 0x0a, 0x09, 0x41, 0x75, 0x74, 0x68,
	0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x22, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64,
	...
	0x61, 0x72, 0x64, 0x22, 0x40, 0x0a, 0x0c, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x4d, 0x65, 0x73, 0x73,
...
var file_api_proto_goTypes = []interface{}{
	...
	(ProcessRequest_ProcessType)(0), // 1: ProcessRequest.ProcessType
	...
	(*ProcessRequest_FileInfo)(nil), // 9: ProcessRequest.FileInfo
...
var file_api_proto_depIdxs = []int32{
	10, // 0: ConnectionRequest.profile:type_name -> Profile
	...
	13, // 7: InviteRequest.contact:type_name -> Contact
	8,  // 8: InviteRequest.files:type_name -> InviteRequest.FileInfo
	9,  // 9: ProcessRequest.files:type_name -> ProcessRequest.FileInfo
	...
	16, // 13: AuthReply.payload:type_name -> Payload
...
func file_api_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProcessRequest_FileInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
