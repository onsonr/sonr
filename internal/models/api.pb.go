...
func (x *CompletedTransfer) GetPayload() Payload {
	if x != nil {
		return x.Payload
	}
	return Payload_NONE
...
func (x *CompletedTransfer) GetFrom() *Peer {
	if x != nil {
		return x.From
	}
	return nil
...
func (x *CompletedTransfer) GetMetadata() *Metadata {
	if x != nil {
		return x.Metadata
	}
	return nil
...
var file_api_proto_rawDesc = []byte{
	...
	0x61, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe6, 0x01, 0x0a, 0x11, 0x43, 0x6f, 0x6e, 0x6e,
	...
	0x6e, 0x67, 0x69, 0x74, 0x75, 0x64, 0x65, 0x12, 0x22, 0x0a, 0x07, 0x70, 0x72, 0x6f, 0x66, 0x69,
	0x6c, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x08, 0x2e, 0x50, 0x72, 0x6f, 0x66, 0x69,
	0x6c, 0x65, 0x52, 0x07, 0x70, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x12, 0x1f, 0x0a, 0x06, 0x64,
	...
	0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x69, 0x65, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28,
	...
	0x74, 0x52, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x63, 0x74, 0x22, 0x79, 0x0a, 0x11, 0x43, 0x6f,
	0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x12,
	...
	0x0b, 0x32, 0x05, 0x2e, 0x50, 0x65, 0x65, 0x72, 0x52, 0x04, 0x66, 0x72, 0x6f, 0x6d, 0x12, 0x25,
	...
	0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0x40, 0x0a, 0x0c, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x4d, 0x65,
	...
	0x06, 0x6d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x2a, 0x53, 0x0a, 0x07, 0x50, 0x61, 0x79, 0x6c, 0x6f,
	0x61, 0x64, 0x12, 0x08, 0x0a, 0x04, 0x4e, 0x4f, 0x4e, 0x45, 0x10, 0x00, 0x12, 0x09, 0x0a, 0x05,
	0x49, 0x4d, 0x41, 0x47, 0x45, 0x10, 0x01, 0x12, 0x09, 0x0a, 0x05, 0x56, 0x49, 0x44, 0x45, 0x4f,
	0x10, 0x02, 0x12, 0x08, 0x0a, 0x04, 0x46, 0x49, 0x4c, 0x45, 0x10, 0x03, 0x12, 0x0b, 0x0a, 0x07,
	0x43, 0x4f, 0x4e, 0x54, 0x41, 0x43, 0x54, 0x10, 0x04, 0x12, 0x07, 0x0a, 0x03, 0x55, 0x52, 0x4c,
	0x10, 0x05, 0x12, 0x08, 0x0a, 0x04, 0x54, 0x45, 0x58, 0x54, 0x10, 0x06, 0x42, 0x0a, 0x5a, 0x08,
...
var file_api_proto_goTypes = []interface{}{
	(Payload)(0),              // 0: Payload
	(AuthInvite_Type)(0),      // 1: AuthInvite.Type
	(*ConnectionRequest)(nil), // 2: ConnectionRequest
	(*ProcessRequest)(nil),    // 3: ProcessRequest
	(*AuthInvite)(nil),        // 4: AuthInvite
	(*AuthReply)(nil),         // 5: AuthReply
	(*CompletedTransfer)(nil), // 6: CompletedTransfer
...
var file_api_proto_depIdxs = []int32{
	...
	1,  // 8: AuthInvite.type:type_name -> AuthInvite.Type
	0,  // 9: AuthReply.payload:type_name -> Payload
	12, // 10: AuthReply.from:type_name -> Peer
	11, // 11: AuthReply.contact:type_name -> Contact
	0,  // 12: CompletedTransfer.payload:type_name -> Payload
	12, // 13: CompletedTransfer.from:type_name -> Peer
	14, // 14: CompletedTransfer.metadata:type_name -> Metadata
