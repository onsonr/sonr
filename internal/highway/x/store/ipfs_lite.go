...
// GetData returns a file
func (i *IPFSLite) GetData(cid string) ([]byte, error) {
...
func (i *IPFSLite) PutData(data []byte) (*cid.Cid, error) {
...
func (i *IPFSLite) RemoveFile(cidstr string) error {
