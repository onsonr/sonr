...
var file_proto_common_event_proto_rawDesc = []byte{
	...
	0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0x77, 0x0a, 0x0d, 0x50, 0x72, 0x6f, 0x67,
	...
	0x67, 0x72, 0x65, 0x73, 0x73, 0x12, 0x1a, 0x0a, 0x08, 0x72, 0x65, 0x63, 0x65, 0x69, 0x76, 0x65,
	0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x72, 0x65, 0x63, 0x65, 0x69, 0x76, 0x65,
	0x64, 0x22, 0xb9, 0x02, 0x0a, 0x0d, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x45, 0x76,
	...
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x2c, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64,
	...
	0x2e, 0x50, 0x65, 0x65, 0x72, 0x52, 0x02, 0x74, 0x6f, 0x12, 0x1c, 0x0a, 0x09, 0x63, 0x72, 0x65,
	0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x63, 0x72,
	0x65, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x12, 0x1e, 0x0a, 0x0a, 0x72, 0x65, 0x63, 0x65, 0x69,
	0x76, 0x65, 0x64, 0x41, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0a, 0x72, 0x65, 0x63,
	0x65, 0x69, 0x76, 0x65, 0x64, 0x41, 0x74, 0x22, 0x34, 0x0a, 0x09, 0x44, 0x69, 0x72, 0x65, 0x63,
	...
	0x0c, 0x0a, 0x08, 0x4f, 0x55, 0x54, 0x47, 0x4f, 0x49, 0x4e, 0x47, 0x10, 0x02, 0x42, 0x29, 0x5a,
...
var file_proto_common_event_proto_goTypes = []interface{}{
	...
	(*ProgressEvent)(nil),        // 4: sonr.core.ProgressEvent
	(*CompleteEvent)(nil),        // 5: sonr.core.CompleteEvent
	(*Peer)(nil),                 // 6: sonr.core.Peer
	(*Payload)(nil),              // 7: sonr.core.Payload
}
var file_proto_common_event_proto_depIdxs = []int32{
	6, // 0: sonr.core.DecisionEvent.from:type_name -> sonr.core.Peer
	6, // 1: sonr.core.RefreshEvent.peers:type_name -> sonr.core.Peer
	6, // 2: sonr.core.InviteEvent.from:type_name -> sonr.core.Peer
	7, // 3: sonr.core.InviteEvent.payload:type_name -> sonr.core.Payload
	0, // 4: sonr.core.CompleteEvent.direction:type_name -> sonr.core.CompleteEvent.Direction
	7, // 5: sonr.core.CompleteEvent.payload:type_name -> sonr.core.Payload
	6, // 6: sonr.core.CompleteEvent.from:type_name -> sonr.core.Peer
	6, // 7: sonr.core.CompleteEvent.to:type_name -> sonr.core.Peer
