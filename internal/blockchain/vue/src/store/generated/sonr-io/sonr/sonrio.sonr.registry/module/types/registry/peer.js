...
(function (Connection) {
    Connection[Connection["CONNECTION_UNSPECIFIED"] = 0] = "CONNECTION_UNSPECIFIED";
...
export const Location = {
    encode(message, writer = Writer.create()) {
        ...
        if (message.placemark !== undefined) {
            Location_Placemark.encode(message.placemark, writer.uint32(26).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    message.placemark = Location_Placemark.decode(reader, reader.uint32());
                    break;
                case 4:
...
export const Location_Placemark = {
    ...
    fromJSON(object) {
        ...
        if (object.administrativeArea !== undefined &&
        ...
        if (object.subAdministrativeArea !== undefined &&
        ...
        if (object.subThoroughfare !== undefined &&
...
export const Profile = {
    ...
    toJSON(message) {
        ...
        message.picture !== undefined &&
            (obj.picture = base64FromBytes(message.picture !== undefined ? message.picture : new Uint8Array()));
