...
func Navbar() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<!-- Site header --><header class=\"absolute w-full z-30\"><div class=\"max-w-6xl mx-auto px-4 sm:px-6\"><div class=\"flex items-center justify-between h-16 md:h-20\"><!-- Site branding --><div class=\"flex-1\"><!-- Logo --><a class=\"inline-flex\" href=\"index.html\" aria-label=\"Cruip\"><img class=\"max-w-none\" src=\"https://cdn.sonr.build/images/logo.svg\" width=\"38\" height=\"38\" alt=\"Stellar\"></a></div><!-- Desktop navigation --><nav class=\"hidden md:flex md:grow\"><!-- Desktop menu links --><ul class=\"flex grow justify-center flex-wrap items-center\"><li><a class=\"font-medium text-sm text-slate-300 hover:text-white mx-4 lg:mx-5 transition duration-150 ease-in-out\" href=\"about.html\">About</a></li><li><a class=\"font-medium text-sm text-slate-300 hover:text-white mx-4 lg:mx-5 transition duration-150 ease-in-out\" href=\"integrations.html\">Ecosystem</a></li><li><a class=\"font-medium text-sm text-slate-300 hover:text-white mx-4 lg:mx-5 transition duration-150 ease-in-out\" href=\"customers.html\">Research</a></li><li><a class=\"font-medium text-sm text-slate-300 hover:text-white mx-4 lg:mx-5 transition duration-150 ease-in-out\" href=\"changelog.html\">Changelog</a></li></ul></nav><!-- Desktop sign in links --><ul class=\"flex-1 flex justify-end items-center\"><li><a class=\"font-medium text-sm text-slate-300 hover:text-white whitespace-nowrap transition duration-150 ease-in-out\" href=\"signin.html\">Sign in</a></li><li class=\"ml-6\"><a class=\"btn-sm text-slate-300 hover:text-white transition duration-150 ease-in-out w-full group [background:linear-gradient(theme(colors.slate.900),_theme(colors.slate.900))_padding-box,_conic-gradient(theme(colors.slate.400),_theme(colors.slate.700)_25%,_theme(colors.slate.700)_75%,_theme(colors.slate.400)_100%)_border-box] relative before:absolute before:inset-0 before:bg-slate-800/30 before:rounded-full before:pointer-events-none\" href=\"signup.html\"><span class=\"relative inline-flex items-center\">Sign up <span class=\"tracking-normal text-purple-500 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1\">-&gt;</span></span></a></li></ul><!-- Mobile menu --><div class=\"md:hidden flex items-center ml-4\" x-data=\"{ expanded: false }\"><!-- Hamburger button --><button class=\"hamburger\" :class=\"{ &#39;active&#39;: expanded }\" @click.stop=\"expanded = !expanded\" aria-controls=\"mobile-nav\" :aria-expanded=\"expanded\"><span class=\"sr-only\">Menu</span> <svg class=\"w-5 h-5 fill-current text-slate-300 hover:text-white transition duration-150 ease-in-out\" viewBox=\"0 0 20 20\" xmlns=\"http://www.w3.org/2000/svg\"><rect y=\"2\" width=\"20\" height=\"2\" rx=\"1\"></rect> <rect y=\"9\" width=\"20\" height=\"2\" rx=\"1\"></rect> <rect y=\"16\" width=\"20\" height=\"2\" rx=\"1\"></rect></svg></button><!-- Mobile navigation --><nav id=\"mobile-nav\" class=\"absolute top-full z-20 left-0 w-full px-4 sm:px-6 overflow-hidden transition-all duration-300 ease-in-out\" x-ref=\"mobileNav\" :style=\"expanded ? &#39;max-height: &#39; + $refs.mobileNav.scrollHeight + &#39;px; opacity: 1&#39; : &#39;max-height: 0; opacity: .8&#39;\" @click.outside=\"expanded = false\" @keydown.escape.window=\"expanded = false\" x-cloak><ul class=\"border border-transparent [background:linear-gradient(theme(colors.slate.900),_theme(colors.slate.900))_padding-box,_conic-gradient(theme(colors.slate.400),_theme(colors.slate.700)_25%,_theme(colors.slate.700)_75%,_theme(colors.slate.400)_100%)_border-box] rounded-lg px-4 py-1.5\"><li><a class=\"flex font-medium text-sm text-slate-300 hover:text-white py-1.5\" href=\"about.html\">About</a></li><li><a class=\"flex font-medium text-sm text-slate-300 hover:text-white py-1.5\" href=\"integrations.html\">Ecosystem</a></li><li><a class=\"flex font-medium text-sm text-slate-300 hover:text-white py-1.5\" href=\"customers.html\">Research</a></li><li><a class=\"flex font-medium text-sm text-slate-300 hover:text-white py-1.5\" href=\"changelog.html\">Changelog</a></li></ul></nav></div></div></div></header>")
