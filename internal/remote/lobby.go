...
func (tm *RemoteManager) handleTopicEvents() {
	// @ Loop Events
	for {
		// Get next event
...
func (tm *RemoteManager) handleTopicMessages() {
	for {
...
func (tm *RemoteManager) processTopicMessages() {
	for {
		select {
...
func (tm *RemoteManager) handleMessage(e *md.LobbyEvent) {
	switch e.Event.(type) {
	// Local Event
