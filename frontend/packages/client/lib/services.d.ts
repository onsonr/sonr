...
export default class Services {
     ...
     */
    get(name: string): Promise<ServiceRecord>;
    /**
     ...
     */
    startRegistration(alias: string): Promise<QueryAttestionResponse>;
    /**
     ...
     */
    finishRegistration(alias: string, credential_response: string, challenge: string, ucwId: string): Promise<RegistrationResponse>;
    /**
     ...
     */
    startLogin(alias: string): Promise<QueryAssertionResponse>;
    /**
     ...
     */
    finishLogin(alias: string, assertion_response: string): Promise<LoginResponse>;
}
