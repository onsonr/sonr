...
const Steps = ({ steps, setStep }: StepsProps) => {
    return (
                ...
                {steps.map((step, stepIdx) => (
                    <li key={step.name} className="relative md:flex md:flex-1">
                        {step.status === 'complete' ? (
                            <Button variant="ghost" onClick={() => step.onClick()} className="group flex w-full items-center">
                            ...
                            <Button variant="ghost" onClick={() => step.onClick()} className="flex items-center px-6 py-4 text-sm font-medium" aria-current="step">
                            ...
                            <Button variant="ghost" onClick={() => step.onClick()} className="group flex items-center">
                                <span className="flex items-center px-6 py-4 text-sm font-medium">
