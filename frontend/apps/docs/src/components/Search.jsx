                ...
                queries: [
                  {
                    ...
                    params: {
                      hitsPerPage: 5,
                      highlightPreTag:
                        '<mark class="underline bg-transparent text-cyan-500">',
...
function SearchIcon(props) {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden="true" {...props}>
      <path fill-rule="evenodd" clip-rule="evenodd" d="M9 21C9 20.4477 9.44772 20 10 20H14C14.5523 20 15 20.4477 15 21C15 21.5523 14.5523 22 14 22H10C9.44772 22 9 21.5523 9 21Z" fill="url(#paint0_linear_8_151)" />
      <path fill-rule="evenodd" clip-rule="evenodd" d="M15.5 15.6403C15.5 15.2834 15.6936 14.958 15.9869 14.7545C17.8078 13.4905 19 11.3845 19 9C19 5.13401 15.866 2 12 2C8.13401 2 5 5.13401 5 9C5 11.3845 6.19225 13.4905 8.01313 14.7544C8.30638 14.958 8.5 15.2833 8.5 15.6403V16C8.5 17.3807 9.61929 18.5 11 18.5H13C14.3807 18.5 15.5 17.3807 15.5 16V15.6403Z" fill="url(#paint1_linear_8_151)" />
      <defs>
        <linearGradient id="paint0_linear_8_151" x1="15.0642" y1="20.0159" x2="14.2227" y2="23.3273" gradientUnits="userSpaceOnUse">
          <stop stop-color="#FCFCFD" />
          <stop offset="0.0001" stop-color="white" />
          <stop offset="0.447917" stop-color="white" />
          <stop offset="1" stop-color="white" stop-opacity="0.7" />
        </linearGradient>
        <linearGradient id="paint1_linear_8_151" x1="19.1498" y1="2.13095" x2="4.69078" y2="18.2221" gradientUnits="userSpaceOnUse">
          <stop stop-color="#FCFCFD" />
          <stop offset="0.0001" stop-color="white" />
          <stop offset="0.447917" stop-color="white" />
          <stop offset="1" stop-color="white" stop-opacity="0.7" />
