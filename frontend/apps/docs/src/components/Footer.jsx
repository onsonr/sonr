...
const FeedbackThanks = forwardRef(function FeedbackThanks(_props, ref) {
  return (
    ...
    >
      <div className="flex items-center gap-3 rounded-full bg-cyan-50/50 py-1 pr-3 pl-1.5 text-sm text-cyan-900 ring-1 ring-inset ring-cyan-500/20 dark:bg-cyan-500/5 dark:text-cyan-200 dark:ring-cyan-500/30">
  ...
  return (
    <div className="flex flex-col items-center justify-between gap-5 border-t border-zinc-900/5 pt-8 dark:border-white/5 sm:flex-row">
      ...
      <div className="flex gap-4">
        <SocialLink href="https://snr.la/tw" icon={TwitterIcon}>
          Follow us on Twitter
        </SocialLink>
        <SocialLink href="https://snr.la/gh-sonr" icon={GitHubIcon}>
          Follow us on GitHub
        </SocialLink>
        <SocialLink href="https://snr.la/dev-chat" icon={DiscordIcon}>
