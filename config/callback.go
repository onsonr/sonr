...
func DefaultConfiguration() *Configuration {
	...
	c := &Configuration{
		connection: types.Connection_CONNECTION_WIFI,
...
func NewDefaultLocation() *types.Location {
	return &types.Location{
		Latitude:  float64(40.673010),
		Longitude: float64(-73.994450),
		Placemark: &types.Location_Placemark{
			Name:                  "Sonr HQ",
			Street:                "94 9th St.",
			IsoCountryCode:        "US",
...
func NewDefaultProfile(options ...DefaultProfileOption) *types.Profile {
	// Set default options
	...
	buildProfile := func(opts profileOpts) *types.Profile {
...
func WithCheckerProfile(profile *types.Profile) DefaultProfileOption {
...
func checkProfile(p *types.Profile) bool {
	if p == nil {
		return false
	}
