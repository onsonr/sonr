...
replace (
	github.com/99designs/keyring => github.com/sonr-io/keyring v1.2.2-0.20220630231936-527ca43d58a6
...
require (
	...
	github.com/sonr-io/keyring v1.2.2-0.20220630231936-527ca43d58a6 // indirect
