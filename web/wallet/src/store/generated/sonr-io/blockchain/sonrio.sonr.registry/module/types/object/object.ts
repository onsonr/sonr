...
export interface ObjectField {
  ...
  string_value: ObjectFieldText | undefined;
  /** Number is the value of the field */
  number_value: ObjectFieldNumber | undefined;
  /** Float is the value of the field */
  bool_value: ObjectFieldBool | undefined;
  /** Array is the value of the field */
  array_value: ObjectFieldArray | undefined;
  /** Time is defined by milliseconds since epoch. */
  time_stamp_value: ObjectFieldTime | undefined;
  /** Geopoint is the value of the field */
  geopoint_value: ObjectFieldGeopoint | undefined;
  /** Blob is the value of the field */
  blob_value: ObjectFieldBlob | undefined;
  /** Blockchain Address is the value of the field */
  blockchain_addr_value: ObjectFieldBlockchainAddress | undefined;
...
export const ObjectField = {
  encode(message: ObjectField, writer: Writer = Writer.create()): Writer {
    ...
    if (message.time_stamp_value !== undefined) {
      ObjectFieldTime.encode(
        message.time_stamp_value,
        writer.uint32(66).fork()
      ).ldelim();
    }
    if (message.geopoint_value !== undefined) {
      ObjectFieldGeopoint.encode(
        message.geopoint_value,
        writer.uint32(74).fork()
      ).ldelim();
    }
    if (message.blob_value !== undefined) {
      ObjectFieldBlob.encode(
        message.blob_value,
        writer.uint32(82).fork()
      ).ldelim();
    }
    if (message.blockchain_addr_value !== undefined) {
      ObjectFieldBlockchainAddress.encode(
        message.blockchain_addr_value,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          message.string_value = ObjectFieldText.decode(
            reader,
            reader.uint32()
          );
          break;
        case 5:
          message.number_value = ObjectFieldNumber.decode(
            reader,
            reader.uint32()
          );
          break;
        case 6:
          message.bool_value = ObjectFieldBool.decode(reader, reader.uint32());
          break;
        case 7:
          message.array_value = ObjectFieldArray.decode(
            reader,
            reader.uint32()
          );
          break;
        case 8:
          message.time_stamp_value = ObjectFieldTime.decode(
            reader,
            reader.uint32()
          );
          break;
        case 9:
          message.geopoint_value = ObjectFieldGeopoint.decode(
            reader,
            reader.uint32()
          );
          break;
        case 10:
          message.blob_value = ObjectFieldBlob.decode(reader, reader.uint32());
          break;
        case 12:
          message.blockchain_addr_value = ObjectFieldBlockchainAddress.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object: any): ObjectField {
    ...
    if (object.string_value !== undefined && object.string_value !== null) {
      message.string_value = ObjectFieldText.fromJSON(object.string_value);
    } else {
      message.string_value = undefined;
    }
    if (object.number_value !== undefined && object.number_value !== null) {
      message.number_value = ObjectFieldNumber.fromJSON(object.number_value);
    } else {
      message.number_value = undefined;
    }
    if (object.bool_value !== undefined && object.bool_value !== null) {
      message.bool_value = ObjectFieldBool.fromJSON(object.bool_value);
    } else {
      message.bool_value = undefined;
    }
    if (object.array_value !== undefined && object.array_value !== null) {
      message.array_value = ObjectFieldArray.fromJSON(object.array_value);
    } else {
      message.array_value = undefined;
    }
    if (
      object.time_stamp_value !== undefined &&
      object.time_stamp_value !== null
    ) {
      message.time_stamp_value = ObjectFieldTime.fromJSON(
        object.time_stamp_value
      );
    } else {
      message.time_stamp_value = undefined;
    }
    if (object.geopoint_value !== undefined && object.geopoint_value !== null) {
      message.geopoint_value = ObjectFieldGeopoint.fromJSON(
        object.geopoint_value
      );
    } else {
      message.geopoint_value = undefined;
    }
    if (object.blob_value !== undefined && object.blob_value !== null) {
      message.blob_value = ObjectFieldBlob.fromJSON(object.blob_value);
    } else {
      message.blob_value = undefined;
    }
    if (
      object.blockchain_addr_value !== undefined &&
      object.blockchain_addr_value !== null
    ) {
      message.blockchain_addr_value = ObjectFieldBlockchainAddress.fromJSON(
        object.blockchain_addr_value
      );
    } else {
      message.blockchain_addr_value = undefined;
    }
  ...
  toJSON(message: ObjectField): unknown {
    ...
    message.string_value !== undefined &&
      (obj.string_value = message.string_value
        ? ObjectFieldText.toJSON(message.string_value)
        : undefined);
    message.number_value !== undefined &&
      (obj.number_value = message.number_value
        ? ObjectFieldNumber.toJSON(message.number_value)
        : undefined);
    message.bool_value !== undefined &&
      (obj.bool_value = message.bool_value
        ? ObjectFieldBool.toJSON(message.bool_value)
        : undefined);
    message.array_value !== undefined &&
      (obj.array_value = message.array_value
        ? ObjectFieldArray.toJSON(message.array_value)
        : undefined);
    message.time_stamp_value !== undefined &&
      (obj.time_stamp_value = message.time_stamp_value
        ? ObjectFieldTime.toJSON(message.time_stamp_value)
        : undefined);
    message.geopoint_value !== undefined &&
      (obj.geopoint_value = message.geopoint_value
        ? ObjectFieldGeopoint.toJSON(message.geopoint_value)
        : undefined);
    message.blob_value !== undefined &&
      (obj.blob_value = message.blob_value
        ? ObjectFieldBlob.toJSON(message.blob_value)
        : undefined);
    message.blockchain_addr_value !== undefined &&
      (obj.blockchain_addr_value = message.blockchain_addr_value
        ? ObjectFieldBlockchainAddress.toJSON(message.blockchain_addr_value)
        : undefined);
    obj.metadata = {};
    if (message.metadata) {
  ...
  fromPartial(object: DeepPartial<ObjectField>): ObjectField {
    ...
    if (object.string_value !== undefined && object.string_value !== null) {
      message.string_value = ObjectFieldText.fromPartial(object.string_value);
    } else {
      message.string_value = undefined;
    }
    if (object.number_value !== undefined && object.number_value !== null) {
      message.number_value = ObjectFieldNumber.fromPartial(object.number_value);
    } else {
      message.number_value = undefined;
    }
    if (object.bool_value !== undefined && object.bool_value !== null) {
      message.bool_value = ObjectFieldBool.fromPartial(object.bool_value);
    } else {
      message.bool_value = undefined;
    }
    if (object.array_value !== undefined && object.array_value !== null) {
      message.array_value = ObjectFieldArray.fromPartial(object.array_value);
    } else {
      message.array_value = undefined;
    }
    if (
      ...
      message.time_stamp_value = ObjectFieldTime.fromPartial(
        object.time_stamp_value
      );
    } else {
      message.time_stamp_value = undefined;
    ...
    if (object.geopoint_value !== undefined && object.geopoint_value !== null) {
      message.geopoint_value = ObjectFieldGeopoint.fromPartial(
        object.geopoint_value
      );
    } else {
      message.geopoint_value = undefined;
    ...
    if (object.blob_value !== undefined && object.blob_value !== null) {
      message.blob_value = ObjectFieldBlob.fromPartial(object.blob_value);
    } else {
      message.blob_value = undefined;
    }
    if (
      ...
      message.blockchain_addr_value = ObjectFieldBlockchainAddress.fromPartial(
        object.blockchain_addr_value
      );
    } else {
      message.blockchain_addr_value = undefined;
