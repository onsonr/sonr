...
import { Params } from "../../registry/v1/params";
import { WhoIs } from "../../registry/v1/who_is";
import {
  PageRequest,
  PageResponse,
...
export const QueryWhoIsAliasResponse = {
  ...
  fromJSON(object: any): QueryWhoIsAliasResponse {
    const message = {
      ...baseQueryWhoIsAliasResponse,
    } as QueryWhoIsAliasResponse;
    if (object.WhoIs !== undefined && object.WhoIs !== null) {
  ...
  toJSON(message: QueryWhoIsAliasResponse): unknown {
    const obj: any = {};
    message.WhoIs !== undefined &&
      (obj.WhoIs = message.WhoIs ? WhoIs.toJSON(message.WhoIs) : undefined);
    return obj;
  ...
  fromPartial(
    object: DeepPartial<QueryWhoIsAliasResponse>
...
export const QueryWhoIsControllerResponse = {
  ...
  fromJSON(object: any): QueryWhoIsControllerResponse {
    const message = {
      ...baseQueryWhoIsControllerResponse,
    } as QueryWhoIsControllerResponse;
    if (object.WhoIs !== undefined && object.WhoIs !== null) {
  ...
  toJSON(message: QueryWhoIsControllerResponse): unknown {
    const obj: any = {};
    message.WhoIs !== undefined &&
      (obj.WhoIs = message.WhoIs ? WhoIs.toJSON(message.WhoIs) : undefined);
    return obj;
  ...
  fromPartial(
    object: DeepPartial<QueryWhoIsControllerResponse>
  ): QueryWhoIsControllerResponse {
    const message = {
      ...baseQueryWhoIsControllerResponse,
    } as QueryWhoIsControllerResponse;
