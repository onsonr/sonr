...
import { ObjectDoc } from "./module/types/object/v1/object"
import { TypeField } from "./module/types/object/v1/object"
import { Params } from "./module/types/object/v1/params"
import { WhatIs } from "./module/types/object/v1/what_is"
	...
	actions: {
		...
		async QueryWhatIs({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const queryClient=await initQueryClient(rootGetters)
				let value= (await queryClient.queryWhatIs( key.did)).data
