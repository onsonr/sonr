 ...
 */
export interface BucketBucketDoc {
...
export type BucketMsgUpdateWhichIsResponse = object;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  /**
   * @description Queries a list of WhichIs items.
   *
   * @tags Query
   * @name QueryWhichIsAll
   * @summary WhichIsAll
   * @request GET:/sonr-io/sonr/bucket/which_is
   */
  queryWhichIsAll = (
    query?: {
    ...
    this.request<BucketQueryAllWhichIsResponse, RpcStatus>({
      path: `/sonr-io/sonr/bucket/which_is`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   */
  queryWhichIs = (did: string, params: RequestParams = {}) =>
  ...
  queryParams = (params: RequestParams = {}) =>
    this.request<BucketQueryParamsResponse, RpcStatus>({
