...
// func NewMultiSession(n *node.Motor, id party.ID, ids []party.ID, pid protocol.ID) (*Session, error) {
// 	ctx := context.Background()

// 	routingDiscovery := drouting.NewRoutingDiscovery(n.Node.DHT)
// 	dutil.Advertise(ctx, routingDiscovery, K_RENDENZVOUS)

// 	ps, err := pubsub.NewFloodSub(ctx, n.Host)
// 	if err != nil {
// 		return nil, err
// 	}
// 	t, err := ps.Join(K_PUBSUB)
// 	if err != nil {
// 		return nil, err
// 	}
// 	sub, err := t.Subscribe()
...
// 	go s.handleRoutingPeerFound(routingDiscovery, n, K_RENDENZVOUS)
// 	return s, nil
// }
...
// // handleRoutingPeerFound finds peers on the network and connects to them.
// func (s *Session) handleRoutingPeerFound(routing *drouting.RoutingDiscovery, m *node.Motor, rendevouz string) {
// 	peerChan, err := routing.FindPeers(s.ctx, rendevouz)
// 	if err != nil {
// 		panic(err)
// 	}
...
// 			continue
// 		}
// 		_, err := m.Host.NewStream(s.ctx, peer.ID)
// 		if err != nil {
// 			continue
// 		}
// 	}
