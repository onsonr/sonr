...
import (
	...
	"github.com/sonr-io/core/pkg/gocmd"
...
func TestNewPlugin(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			expectedPlugin: Plugin{
				...
				cloneDir:   ".sonr/plugins/github.com/ignite/plugin",
				reference:  "",
				srcPath:    ".sonr/plugins/github.com/ignite/plugin",
				binaryName: "plugin",
			},
		},
		{
			...
			expectedPlugin: Plugin{
				...
				cloneURL:   "https://github.com/ignite/plugin",
				cloneDir:   ".sonr/plugins/github.com/ignite/plugin-develop",
				reference:  "develop",
				srcPath:    ".sonr/plugins/github.com/ignite/plugin-develop",
				binaryName: "plugin",
			},
		},
		{
			...
			expectedPlugin: Plugin{
				...
				cloneURL:   "https://github.com/ignite/plugin",
				cloneDir:   ".sonr/plugins/github.com/ignite/plugin-package-v1.0.0",
				reference:  "package/v1.0.0",
				srcPath:    ".sonr/plugins/github.com/ignite/plugin-package-v1.0.0",
				binaryName: "plugin",
			},
		},
		{
			...
			expectedPlugin: Plugin{
				...
				cloneDir:   ".sonr/plugins/github.com/ignite/plugin",
				reference:  "",
				srcPath:    ".sonr/plugins/github.com/ignite/plugin/plugin1",
				binaryName: "plugin1",
			},
		},
		{
			...
			expectedPlugin: Plugin{
				...
				cloneDir:   ".sonr/plugins/github.com/ignite/plugin-develop",
				reference:  "develop",
				srcPath:    ".sonr/plugins/github.com/ignite/plugin-develop/plugin1",
				binaryName: "plugin1",
			},
		},
		{
			...
			expectedPlugin: Plugin{
				...
				cloneDir:   ".sonr/plugins/github.com/ignite/plugin-package-v1.0.0",
				reference:  "package/v1.0.0",
				srcPath:    ".sonr/plugins/github.com/ignite/plugin-package-v1.0.0/plugin1",
				binaryName: "plugin1",
			},
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			p := newPlugin(".sonr/plugins", tt.pluginCfg)
